!(function (e, t) {
  ...
  const s = new Map(),
    ...
    N = 'transitionend',
    F = (e) =>
      (e = e && window.CSS && window.CSS.escape ? e.replace(/#([^\s"#']+)/g, (e, t) => '#' + CSS.escape(t)) : e),
    H = (e) => {
      e.dispatchEvent(new Event(N));
    },
    r = (e) => !(!e || 'object' != typeof e) && void 0 !== (e = void 0 !== e.jquery ? e[0] : e).nodeType,
    n = (e) =>
      r(e) ? (e.jquery ? e[0] : e) : 'string' == typeof e && 0 < e.length ? document.querySelector(F(e)) : null,
    a = (e) => {
      ...
      if (e) {
        e =
          ((e) => {
            ...
            return e || s
              ? ((t = t.split(',')[0]), (i = i.split(',')[0]), (Number.parseFloat(t) + Number.parseFloat(i)) * j)
              : 0;
          })(s) + 5;
        let t = !1;
        const n = ({ target: e }) => {
    ...
    X = (e, t, i, s) => {
      ...
      return -1 === r
        ? !i && s
          ? e[n - 1]
          : e[0]
        : ((r += i ? 1 : -1), s && (r = (r + n) % n), e[Math.max(0, Math.min(r, n - 1))]);
    },
    G = /[^.]*(?=\..*)\.|.*/,
    U = /\..*/,
    Q = /::\d+$/,
            ...
            ? ((u = s),
              ...
              function t(i) {
                ...
                for (let e = i['target']; e && e !== this; e = e.parentNode)
                  for (const n of s)
                    if (n === e)
                      return le(i, { delegateTarget: e }), t.oneOff && f.off(u, i.type, h, p), p.apply(e, [i]);
              })
            : ((c = s),
              (d = t),
              function e(t) {
    ...
    constructor(e, t) {
      super(),
        (e = n(e)) &&
          ...
          D.set(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  var pe = (t, i = 'hide') => {
    ...
    f.on(document, e, `[data-bs-dismiss="${s}"]`, function (e) {
      ['A', 'AREA'].includes(this.tagName) && e.preventDefault(),
        o(this) || ((e = u.getElementFromSelector(this) || this.closest('.' + s)), t.getOrCreateInstance(e)[i]());
    });
  };
  class me extends t {
    static get NAME() {
  ...
  class Pe extends t {
    ...
    to(e) {
      ...
      e > i.length - 1 ||
        e < 0 ||
        (this._isSliding
          ? f.one(this._element, _e, () => this.to(e))
          : (t = this._getItemIndex(this._getActive())) !== e && ((t = t < e ? we : p), this._slide(t, i[e])));
    }
    dispose() {
    ...
    _keydown(e) {
      ...
      /input|textarea/i.test(e.target.tagName) ||
        ((t = ke[e.key]) && (e.preventDefault(), this._slide(this._directionToOrder(t))));
    }
    _getItemIndex(e) {
    ...
    _setActiveIndicatorElement(e) {
      ...
      this._indicatorsElement &&
        ((t = u.findOne(Se, this._indicatorsElement)).classList.remove(Ee),
  ...
  function lt(e) {
    for (
      var t, i = b(e), s = ot(e);
      s && ((t = s), 0 <= ['table', 'td', 'th'].indexOf(v(t))) && 'static' === x(s).position;

    )
      s = ot(s);
    return (
      ((!s || ('html' !== v(s) && ('body' !== v(s) || 'static' !== x(s).position))) &&
        (s ||
          (function (e) {
  ...
  var mt = {
    ...
    fn: function (e) {
      ...
      o &&
        ...
        (i = ht(
          'number' !=
            typeof (e = 'function' == typeof e ? e(Object.assign({}, i.rects, { placement: i.placement })) : e)
            ? e
            : pt(e, I)
        )),
        (e = nt(o)),
        ...
        (n = i[n]),
        (i = o - e[d] - i[s]),
        (n = dt(n, (s = o / 2 - e[d] / 2 + (t / 2 - l / 2)), i)),
        (r.modifiersData[a] = (((o = {})[c] = n), (o.centerOffset = n - s), o)));
    },
    effect: function (e) {
      var t = e.state;
  ...
  function vt(e) {
    var t,
      ...
      v =
        (c &&
          ...
          (t = 'clientWidth'),
          (y = lt(i)) === b(i) &&
            'static' !== x((y = _(i))).position &&
            'absolute' === o &&
            ((v = 'scrollHeight'), (t = 'scrollWidth')),
          (n !== k && ((n !== P && n !== M) || r !== Ne)) ||
            ((f = A),
            (h =
              (h - ((e && y === g && g.visualViewport ? g.visualViewport.height : y[v]) - s.height)) * (l ? 1 : -1))),
          (n !== P && ((n !== k && n !== A) || r !== Ne)) ||
            ((m = M),
    ...
    return (
      ...
      l
        ...
        : Object.assign({}, v, (((s = {})[f] = a ? h + 'px' : ''), (s[m] = p ? u + 'px' : ''), (s.transform = ''), s))
    );
  }
  var yt = {
      name: 'computeStyles',
  ...
  function Pt(e, t, i) {
    return t === He
      ? Mt(
          ...
          (d = c = 0),
          a &&
            ((l = a.width), (o = a.height), (r = it()) || (!r && 'fixed' === n)) &&
            ((c = a.offsetLeft), (d = a.offsetTop)),
          { width: l, height: o, x: c + Ct(s), y: d })
        )
      : y(t)
        ...
        : Mt(
            ...
            (s = C(l.scrollWidth, l.clientWidth, c ? c.scrollWidth : 0, c ? c.clientWidth : 0)),
            (d = C(l.scrollHeight, l.clientHeight, c ? c.scrollHeight : 0, c ? c.clientHeight : 0)),
            (a = -o.scrollLeft + Ct(a)),
            (o = -o.scrollTop),
            'rtl' === x(c || l).direction && (a += C(l.clientWidth, c ? c.clientWidth : 0) - s),
            { width: s, height: d, x: a, y: o })
          );
    var s, n, r, a, o, l, c, d;
  }
  function It(i, e, t, s) {
    var n,
      r =
        'clippingParents' === e
          ? ((a = At(at((r = i)))),
            y((n = 0 <= ['absolute', 'fixed'].indexOf(x(r).position) && w(r) ? lt(r) : r))
              ? a.filter(function (e) {
  ...
  function Lt(e, t) {
    var s,
      ...
      a = Ot({ reference: r, element: c, strategy: 'absolute', placement: i }),
      ...
      if (!u.modifiersData[e]._skip) {
        for (
          var i = t.mainAxis,
            ...
            t = L(a),
            i = i || (t === a || !f ? [_t(a)] : L((i = a)) === je ? [] : ((t = _t(i)), [Et(i), t, Et(t)])),
  ...
  var Nt = {
    ...
    fn: function (e) {
        ...
        t = We.reduce(function (e, t) {
          ...
          return (
            (e[t] =
              ...
              (t = (i = 'function' == typeof s ? s(Object.assign({}, i, { placement: t })) : s)[0] || 0),
              (s = (i[1] || 0) * r),
      ...
      null != a.modifiersData.popperOffsets &&
        ((a.modifiersData.popperOffsets.x += i), (a.modifiersData.popperOffsets.y += s)),
        (a.modifiersData[e] = t);
    }
  };
  var Ft = {
  ...
  var Ht = {
    ...
    fn: function (e) {
      var t,
        ...
        m = Lt(d, { boundary: m, rootBoundary: f, padding: v, altBoundary: g }),
        f = L(d.placement),
        g = !(v = ft(d.placement)),
        b = ct(f),
        w = 'x' === b ? 'y' : 'x',
        ...
        u =
          'number' ==
          typeof (u = 'function' == typeof u ? u(Object.assign({}, d.rects, { placement: d.placement })) : u)
      ...
      x &&
        (h &&
          ...
          (c = dt(y ? Je(a, o + r - t - g) : a, o, y ? C(l, v) : l)),
          (x[b] = c),
          (S[b] = c - o)),
        p &&
          ((s = 'y' == w ? 'height' : 'width'),
          ...
          (a = r ? n : i - _[s] - T[s] - g + u.altAxis),
          (v = r ? i + _[s] + T[s] - g - u.altAxis : h),
          (o = y && r ? ((l = dt((l = a), i, (c = v))), c < l ? c : l) : dt(y ? a : n, i, y ? v : h)),
          (x[w] = o),
          (S[w] = o - i)),
        (d.modifiersData[e] = S));
    },
  ...
  function qt(e, t, i) {
    ...
    return (
      (!s && i) ||
        (('body' === v(t) && !kt(r)) ||
          (e = (s = t) !== b(s) && w(s) ? { scrollLeft: s.scrollLeft, scrollTop: s.scrollTop } : St(s)),
        w(t) ? (((o = st(t, !0)).x += t.clientLeft), (o.y += t.clientTop)) : r && (o.x = Ct(r))),
      { x: a.left + e.scrollLeft - o.x, y: a.top + e.scrollTop - o.y, width: a.width, height: a.height }
    );
  }
  function Bt(e) {
    var i = new Map(),
          ...
          forceUpdate: function () {
            if (!l) {
              var e = a.elements,
                ...
                e = e.popper;
              if (Wt(t, e)) {
                (a.rects = { reference: qt(t, lt(e), 'fixed' === a.options.strategy), popper: nt(e) }),
                  (a.reset = !1),
                ...
                for (var i, s, n, r = 0; r < a.orderedModifiers.length; r++)
                  !0 === a.reset
                    ...
                    : ((i = (n = a.orderedModifiers[r]).fn),
                      ...
                      (n = n.name),
                      'function' == typeof i &&
                        (a = i({ state: a, options: void 0 === s ? {} : s, name: n, instance: c }) || a));
              }
            }
          },
          update:
    ...
    _getPopperConfig() {
      ...
      return (
        (!this._inNavbar && 'static' !== this._config.display) ||
          (d.setDataAttribute(this._menu, 'popper', 'static'), (e.modifiers = [{ name: 'applyStyles', enabled: !1 }])),
        ...
        for (const n of u.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show')) {
          ...
          s &&
            ...
            i.includes(s._element) ||
              ...
              ((i = { relatedTarget: s._element }), 'click' === e.type && (i.clickEvent = e), s._completeHide(i)));
        }
    }
  ...
  f.on(document, mt, T, E.dataApiKeydownHandler),
    f.on(document, mt, Kt, E.dataApiKeydownHandler),
    f.on(document, Ue, E.clearMenus),
  ...
  class ki extends t {
    ...
    show(e) {
      this._isShown ||
        ...
        f.trigger(this._element, _i, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
      ...
      this._queueCallback(
        () => {
          this._config.focus && this._focustrap.activate(),
            (this._isTransitioning = !1),
            f.trigger(this._element, 'shown.bs.modal', { relatedTarget: e });
        },
        this._dialog,
        this._isAnimated()
      );
    ...
    _adjustDialog() {
      var e,
        ...
        s = 0 < i;
      s && !t && ((e = l() ? 'paddingLeft' : 'paddingRight'), (this._element.style[e] = i + 'px')),
        !s && t && ((e = l() ? 'paddingRight' : 'paddingLeft'), (this._element.style[e] = i + 'px'));
    }
    _resetAdjustments() {
  ...
  f.on(document, 'click.bs.offcanvas.data-api', '[data-bs-toggle="offcanvas"]', function (e) {
    ...
    ['A', 'AREA'].includes(this.tagName) && e.preventDefault(),
      o(this) ||
        ...
        (e = u.findOne(Mi)) && e !== t && $.getInstance(e).hide(),
      ...
      if (Object.keys(t).includes(s)) {
        ...
        for (const o of n)
          ((e, t) => {
            ...
            return t.includes(i)
              ? !$i.has(i) || Boolean(zi.test(e.nodeValue))
        ...
        if (!e.defaultPrevented && t) {
          ...
          if (
            (this._element.ownerDocument.documentElement.contains(this.tip) ||
              (t.append(e), f.trigger(this._element, this.constructor.eventName('inserted'))),
    ...
    _setListeners() {
      ...
      for (const i of this._config.trigger.split(' '))
        'click' === i
          ...
          : 'manual' !== i &&
            ((e = i === Yi ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin')),
  ...
  const ts = 'active',
    is = '[href]';
  const ss = { offset: null, rootMargin: '0px 0px -25%', smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
    ns = {
      offset: '(number|null)',
      rootMargin: 'string',
  ...
  class rs extends t {
    ...
    _process(e) {
      this._activeTarget !== e &&
        ...
        f.trigger(this._element, 'activate.bs.scrollspy', { relatedTarget: e }));
    }
    _activateParents(e) {
  ...
  class us extends t {
    ...
    show() {
      ...
      this._elemIsActive(i) ||
        ((t = (e = this._getActiveElem()) ? f.trigger(e, 'hide.bs.tab', { relatedTarget: i }) : null),
        f.trigger(i, 'show.bs.tab', { relatedTarget: e }).defaultPrevented) ||
    ...
    _keydown(t) {
      if (['ArrowLeft', as, 'ArrowUp', os, ls, 'End'].includes(t.key)) {
        ...
        (e = [ls, 'End'].includes(t.key)
          ...
          : ((i = [as, os].includes(t.key)), X(s, t.target, i, !0))) &&
          (e.focus({ preventScroll: !0 }), us.getOrCreateInstance(e).show());
      }
    }
    _getChildren() {
  ...
  class gs extends t {
    ...
    _onInteraction(e, t) {
      ...
      t
        ? this._clearTimeout()
        : ((e = e.relatedTarget), this._element === e || this._element.contains(e) || this._maybeScheduleHide());
    }
    _setListeners() {
              ...
              (e = [
                {
                  ...
                  value: function (e) {
                    var t =
                      1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : { container: document.body };
                    return u(e, t);
                  }
                },
                { key: 'cut', value: d },
                {
                  ...
                  value: function () {
                    var e =
                        'string' ==
                        typeof (e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : ['copy', 'cut'])
                          ? [e]
                          : e,
                  ...
                  value: function (e) {
                    var t = e.delegateTarget || e.currentTarget,
                      e = (function () {
                        var e =
                            void 0 ===
                            (i = (s = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).action)
                              ? 'copy'
                              : i,
                          t = s.container,
                          i = s.target,
      ...
      const t = (e, t = {}) => {
            ...
            const r = l(e.innerHTML, {
              ...
              a =
                ...
                function () {
                  (e.innerHTML = r.shift() || '&nbsp;'),
                    r.length
                      ? (clearTimeout(e.countUpTimeout), (e.countUpTimeout = setTimeout(a, n)))
        ...
        l = (e, t = {}) => {
          const { duration: n = 1e3, delay: i = 16 } = t,
            r = n / i,
            a = e.toString().split(/(<[^>]+>|[0-9.][,.0-9]*[0-9]*)/),
            o = [];
          ...
          for (let t = 0; t < a.length; t++)
            if (/([0-9.][,.0-9]*[0-9]*)/.test(a[t]) && !/<[^>]+>/.test(a[t])) {
              ...
              for (let t = r; 1 <= t; t--) {
                ...
                (e = n.reduce(
                  (e, { char: t, i }) => (e.length <= i ? e : e.slice(0, -i) + t + e.slice(-i)),
                  e.toString()
                )),
                  (o[s--] += e);
              }
  ...
  (function (e, t) {
    ...
    function C(e, t, i) {
      ...
      if (q(e)) console.error('Inject assets error');
        ...
        ((s = document.querySelectorAll('link[href="' + e + '"]')) && 0 < s.length) ||
          ((a = (n = document.getElementsByTagName('head')[0]).querySelectorAll('link[rel="stylesheet"]')),
            ...
            (e.target && e.target.nodeName && 0 <= ['a', 'button', 'input'].indexOf(e.target.nodeName.toLowerCase())
              ...
              : ((this.now = Date.now()),
                ...
                1 < e.touches.length &&
                  ...
                  (i = { x: e.touches[1].pageX - this.x1, y: e.touches[1].pageY - this.y1 }),
                  (t.x = i.x),
                  (t.y = i.y),
        ...
        value: function (e) {
          ...
          e.touches &&
            ...
            1 < t
              ? ((n = e.touches[1].pageX),
                (r = e.touches[1].pageY),
                (o = { x: e.touches[1].pageX - i, y: e.touches[1].pageY - s }),
                null !== a.x &&
                  (0 < this.pinchStartLen &&
                    ((e.zoom = u(o) / this.pinchStartLen), this.pinch.dispatch(e, this.element)),
                  (e.angle = P(o, a)),
                  this.rotate.dispatch(e, this.element)),
                (a.x = o.x),
                (a.y = o.y),
                null !== this.x2 && null !== this.sx2
                  ? ((e.deltaX = (i - this.x2 + n - this.sx2) / 2), (e.deltaY = (s - this.y2 + r - this.sy2) / 2))
    ...
    e(p, [
      {
        ...
        value: function () {
          ...
          this.zoomedIn ||
            ...
            e.naturalWidth > t && ((t = t / 2 - e.naturalWidth / 2), this.setTranslate(this.img.parentNode, t, 0)),
    ...
    e(m, [
      {
        ...
        value: function (e) {
          ...
          -1 !== ['input', 'select', 'textarea', 'button', 'a'].indexOf(t)
            ? (this.active = !1)
            : (e.preventDefault(),
              (e.target === this.el || ('img' !== t && D(e.target, '.gslide-inline'))) &&
                ((this.active = !0),
        ...
        value: function (e) {
          if (this.active) {
            ...
            if (0 < e && e >= Math.abs(this.currentY) && (!this.lastDirection || 'x' == this.lastDirection)) {
              ...
              if (
                (!this.instance.settings.dragAutoSnap && i && (this.doSlideChange = i),
      ...
      },
      {
        ...
        value: function () {
          ...
          return (t =
            ...
            (('left' == (e = 0 < this.currentX ? 'right' : 'left') && this.slide !== this.slide.parentNode.lastChild) ||
              ('right' == e && this.slide !== this.slide.parentNode.firstChild))
              ? e
              : t);
        }
      },
    ...
    function Q(e, t, i, s) {
      var n,
        ...
        o =
          ...
          (r = s.callback),
          (s = s.appendTo),
          ((a = document.createElement('iframe')).className = 'vimeo-video gvideo'),
          (a.src = o),
          (a.style.width = '100%'),
          (a.style.height = '100%'),
    ...
    e(f, [
      ...
      },
      {
        ...
        value: function (s, n) {
          var r = this,
            a = c({ descPosition: n.descPosition }, this.defaults);
          if (d(s) && !H(s))
            return (
              w(s, 'type') ||
          ...
          if (
            ...
            q(l)
              ? (a.title || 'a' != i || q((t = s.title)) || '' === t || (a.title = t),
                a.title || 'img' != i || q((t = s.alt)) || '' === t || (a.title = t))
              : ((o = []),
                h(a, function (e, t) {
                  o.push(';\\s?' + t);
                }),
          ...
          return (
            a.description || ((i = s.querySelector('.glightbox-desc')) && (a.description = i.innerHTML)),
            this.setSize(a, n, s),
            (this.slideConfig = a)
          );
        }
      },
      {
        ...
        value: function (e, t) {
          ...
          return (
            (e.width = w(e, 'width') && '' !== e.width ? this.checkSize(e.width) : s),
    ...
    e(_, [
      {
        ...
        value: function () {
          ...
          F(n.afterSlideLoad) &&
            (p = function () {
              F(e) && e(),
                n.afterSlideLoad({ index: t.index, slide: i, player: t.instance.getSlidePlayerInstance(t.index) });
            }),
            '' == r.title && '' == r.description
              ? h && h.parentNode.parentNode.removeChild(h.parentNode)
              : (d && '' !== r.title ? ((d.id = m), (d.innerHTML = r.title)) : d.parentNode.removeChild(d),
                u && '' !== r.description
                  ? ((u.id = f),
                    a && 0 < n.moreLength
                      ? ((r.smallDescription = this.slideShortDesc(r.description, n.moreLength, n.moreText)),
              ...
              ? function (t, i, s, n) {
                  ...
                  (o.style.maxWidth = i.width),
                    C(this.settings.plyr.js, 'Plyr', function () {
                      ('local' !==
                        (u =
                          !(u = !u && d.match(/vimeo\.com\/([0-9]*)/) ? 'vimeo' : u) &&
                          (d.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) ||
                            d.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/) ||
                            d.match(/(youtube\.com|youtube-nocookie\.com)\/embed\/([a-zA-Z0-9\-_]+)/))
                            ? 'youtube'
                            : u) &&
                        u) ||
                        ((u = 'local'),
                        ...
                        (e =
                          (e =
                            (e += 'style="background:#000; max-width: '.concat(i.width, ';" ')) +
              ...
              : 'external' === o
                ...
                : 'inline' === o
                  ? (function (e, t, i, s) {
                      ...
                      if (
                        (o &&
                          (b(o) && (n = g('<div class="ginlined-content">'.concat(o, '</div>'))), H(o)) &&
                      ...
                      (e.style.height = t.height),
                        ...
                        e.appendChild(n),
                        (this.events['inlineclose' + a] = O('click', {
                  ...
                  : 'image' === o
                    ? ((m = i),
                      ...
                      (a.src = d.href),
                      '' != d.sizes && '' != d.srcset && ((a.sizes = d.sizes), (a.srcset = d.srcset)),
                      (a.alt = ''),
                      q(d.alt) || '' === d.alt || (a.alt = d.alt),
                      '' !== d.title && a.setAttribute('aria-labelledby', u),
                      '' !== d.description && a.setAttribute('aria-describedby', f),
                      d.hasOwnProperty('_hasCustomWidth') && d._hasCustomWidth && (a.style.width = d.width),
                      d.hasOwnProperty('_hasCustomHeight') && d._hasCustomHeight && (a.style.height = d.height),
      ...
      },
      {
        ...
        value: function (e) {
          ...
          s.innerHTML = e;
          var n = i;
          return !((e = s.innerText.trim()).length <= t) && ((e = e.substr(0, t - 1)), n)
            ? ((s = null), e + '... <a href="#" class="desc-more">' + i + '</a>')
            : e;
        }
      },
      {
            ...
            value: function () {
              ...
              0 < window.innerWidth - document.documentElement.clientWidth &&
                ...
                (1 === this.elements.length
                  ? (L(this.prevButton, 'glightbox-button-hidden'), L)
                  : ($(this.prevButton, 'glightbox-button-hidden'), $))(this.nextButton, 'glightbox-button-hidden'),
                (this.lightboxOpen = !0),
                this.trigger('open'),
                  ...
                  ((s = this).events.hasOwnProperty('touch') ||
                    ...
                    (e = new V(e, {
                      touchStart: function (e) {
                        (a = !0),
                          ...
                          (a =
                            ...
                            !z(e.targetTouches[0].target.parentNode, 'gslide-inline')
                              ? !1
                              : a) &&
                            ((S = e.targetTouches[0]),
                            ...
                            769 <
                              (window.innerWidth ||
                                ...
                                document.body.clientWidth) && (o = i.querySelector('.ginner-container')),
                            $(M, 'greset'),
                      ...
                      touchMove: function (e) {
                        if (a && ((S = e.targetTouches[0]), !h) && !p) {
                          ...
                          var i,
                            ...
                            e = k - e;
                          if (
                            (Math.abs(t) > Math.abs(e) ? (T = !(_ = !1)) : (_ = !(T = !1)),
                            (y = S.pageX - E.pageX),
                            (w = (100 * y) / n),
                            (b = S.pageY - E.pageY),
                            (x = (100 * b) / r),
                            _ &&
                              l &&
                              ((i = 1 - Math.abs(b) / r), (M.style.opacity = i), s.settings.touchFollowAxis) &&
                              (w = 0),
                            T &&
                              ((i = 1 - Math.abs(y) / n), (o.style.opacity = i), s.settings.touchFollowAxis) &&
                              (x = 0),
                            !l)
                          )
                            return N(o, 'translate3d('.concat(w, '%, 0, 0)'));
                      ...
                      touchEnd: function () {
                        if (a)
                          if (((c = !1), p || h)) (g = m), (v = f);
                            ...
                            if (!(29 < e && l))
                              return e < 29 && t < 25 ? (L(M, 'greset'), (M.style.opacity = 1), R(o)) : void 0;
                            s.close();
                          }
                      },
                      ...
                      pinch: function (e) {
                        ...
                        (p = !0),
                          e <= 1
                            ? ((p = !1), (e = 1), (f = m = g = v = null), l.setAttribute('style', ''))
            ...
            value: function () {
              ...
              z(r, 'loaded')
                ...
                (this.slideDescriptionContained =
                  this.slideDescription && z(this.slideDescription.parentNode, 'gslide-media')),
            ...
            value: function (e) {
              ...
              return (
                !(
                  ...
                  q(this.elements[e]) ||
                  z((t = this.slidesContainer.querySelectorAll('.gslide')[e]), 'loaded')
                ) &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                (this.elements = r),
                this.lightboxOpen &&
                  ((this.slidesContainer.innerHTML = ''), this.elements.length) &&
            ...
            value: function () {
              ...
              for (e in this.settings.cssEfects)
                this.settings.cssEfects.hasOwnProperty(e) &&
                  ((t = this.settings.cssEfects[e]), i.push('g'.concat(t.in)), i.push('g'.concat(t.out)));
              return i.join(' ');
            }
          },
          {
            ...
            value: function () {
              ...
              var e = document.body.childNodes,
                ...
                e =
                  ((r = g(
                    (r = (r = (r = r.replace(/{nextSVG}/g, e)).replace(/{prevSVG}/g, s)).replace(/{closeSVG}/g, n))
                  )),
              ...
              (this.prevButton = e.querySelector('.gprev')),
                ...
                this.settings.closeOnOutsideClick &&
                  (this.events.outClose = O('click', {
                    onElement: e,
                    withCallback: function (e, t) {
                      i.preventOutsideClick ||
                        z(document.body, 'glightbox-mobile') ||
                        D(e.target, '.ginner-container') ||
                        D(e.target, '.gbtn') ||
                        z(e.target, 'gnext') ||
                        z(e.target, 'gprev') ||
                        i.close();
                ...
                J && (L(document.body, 'glightbox-touch'), (this.settings.autoplayVideos = !1)),
                (this.events.resize = O('resize', {
                  onElement: window,
          ...
          },
          {
            ...
            value: function () {
              ...
              o &&
                ...
                e) &&
                ((n = w(this.settings.plyr.config, 'ratio') ? this.settings.plyr.config.ratio : '') ||
                  ((o = e.clientWidth), (a = e.clientHeight), (n = ''.concat(o / (o = o / a), ':').concat(a / o))),
                (a = n.split(':')),
                ...
                r < n || i < a || (i < a && n < r)
                  ? ((a = e.offsetWidth),
                    ...
                    e.parentNode.setAttribute(
                      'style',
                      'max-width: '.concat((a = { width: a * (r = i / n), height: n * r }).width, 'px')
                    ),
                    s && t.setAttribute('style', 'max-width: '.concat(a.width, 'px;')))
            ...
            value: function () {
              ...
              $(this.nextButton, 'disabled'),
                ...
                0 == this.index && this.elements.length - 1 == 0
                  ? (L(this.prevButton, 'disabled'), L(this.nextButton, 'disabled'))
                  : 0 !== this.index || e
                    ? this.index !== this.elements.length - 1 || e || L(this.nextButton, 'disabled')
    ...
    function e(i, s) {
      ...
      return function () {
        ...
        return (
          ...
          (a = arguments),
          t <= 0
            ? (clearTimeout(c), (c = null), (d = e), (o = i.apply(r, a)), (r = a = null))
            : (c = c || setTimeout(n, t)),
          o
        );
      };
      ...
      (t.prototype = {
        ...
        update: function () {
          (void 0 !== window.pageYOffset
            ? window.pageYOffset
            : (document.documentElement || document.body.parentNode || document.body).scrollTop) > this.scrollOffset
            ? this.stick()
            : this.unstick();
        }
      }),
  ...
  (function (t, i) {
    ...
    function a(e, t, i) {
      ...
      return this instanceof a
        ? (s = 'string' == typeof (s = e) ? document.querySelectorAll(e) : s)
          ? ((this.elements =
              ((n = s), Array.isArray(n) ? n : 'object' == typeof n && 'number' == typeof n.length ? c.call(n) : [n])),
  ...
  (function (e, t) {
    ...
    function y(e) {
      if (
        ...
        if ('none' == t.display) {
          for (
            var i = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, s = 0;
            s < x;
            s++
          )
            i[w[s]] = 0;
          ...
          this.setPosition(e, t),
            n && !this.isTransitioning
              ...
              : (((n = {}).transform = this.getTranslate(e - i, t - s)),
                this.transition({ to: n, onTransitionEnd: { transform: this.layoutPosition }, isCleaning: !0 }));
        }),
    ...
    var l = e.console,
      ...
      p =
        ...
        (h.updateStagger = function () {
          var e,
            t = this.options.stagger;
          return null == t
            ? void (this.stagger = 0)
            : ((this.stagger =
                'number' == typeof (t = t)
                  ? t
                  : ((e = (t = t.match(/(^\d*\.?\d*)(\w*)/)) && t[1]),
                    (t = t && t[2]),
        ...
        (h.dispatchEvent = function (e, t, i) {
          ...
          this.emitEvent(e, s),
            c &&
              ...
              t ? (((s = c.Event(t)).type = e), this.$element.trigger(s, i)) : this.$element.trigger(e, i));
        }),
        (h.ignore = function (e) {
          e = this.getItem(e);
          e && (e.isIgnored = !0);
    ...
    return (
      ...
      (n.getSegmentSize = function (e, t) {
        ...
        this._getMeasurement(e, s),
          this[e] || ((i = this.getFirstItemSize()), (this[e] = (i && i[s]) || this.isotope.size['inner' + t]));
      }),
      ...
      (t._getItemLayoutPosition = function (e) {
        ...
        for (
          var t = e.size.outerWidth % this.columnWidth,
            ...
            i = this[this.options.horizontalOrder ? '_getHorizontalColPosition' : '_getTopColPosition'](t, e),
      ...
      (t._manageStamp = function (e) {
        ...
        for (
          var n = Math.min(this.cols - 1, n),
            r = (this._getOption('originTop') ? e.top : e.bottom) + t.outerHeight,
            a = i;
          a <= n;
          a++
        )
          this.colYs[a] = Math.max(r, this.colYs[a]);
      }),
    ...
    var o = e.jQuery,
      ...
      d =
        ...
        (e._filter = function (e) {
          for (
            var t = this.options.filter, i = [], s = [], n = [], r = this._getFilterTest(t || '*'), a = 0;
            a < e.length;
            a++
          ) {
            var o,
...
!(function () {
      ...
      (i.prototype.handleScroll = function () {
        ...
        for (e in s) {
          ...
          for (n in this.waypoints[e]) {
            ...
            null !== c.triggerPoint &&
              ((o = r.oldScroll < c.triggerPoint), (l = r.newScroll >= c.triggerPoint), (o && l) || (!o && !l)) &&
              (c.queueTrigger(a), (i[c.group.id] = c.group));
          }
        }
            ...
            l.element !== l.element.window && (u = l.adapter.offset()[a.offsetProp]),
              'function' == typeof c
                ...
                : 'string' == typeof c &&
                  ...
                  (c = Math.ceil((a.contextDimension * c) / 100)),
              (o = a.contextScroll - a.contextOffset),
              (l.triggerPoint = Math.floor(u + o - c)),
              (u = d < a.oldScroll),
              (o = l.triggerPoint >= a.oldScroll),
              (c = !u && !o),
              !h && u && o
                ? (l.queueTrigger(a.backward), (n[l.group.id] = l.group))
                : ((!h && c) || (h && a.oldScroll >= l.triggerPoint)) &&
  ...
  (function () {
    ...
    (e.prototype.innerHeight = function () {
      ...
      (e.prototype.off = function (e, t) {
        ...
        else if (s) for (var a in this.handlers) i(r, this.handlers[a][s] || [], t), (this.handlers[a][s] = []);
      ...
      (e.prototype.offset = function () {
        ...
        return this.element.ownerDocument
          ? ((e = this.element.ownerDocument.documentElement),
            (t = s(this.element.ownerDocument)),
            (i = { top: 0, left: 0 }),
            {
              top:
                (i = this.element.getBoundingClientRect ? this.element.getBoundingClientRect() : i).top +
                t.pageYOffset -
                e.clientTop,
  ...
  (function (e, r) {
    ...
    function j(t, d) {
      ...
      function i() {
        for (var e, t, i, s, n, r, a, o = !1, l = {}, c = 0; c < h.length; c++)
          (s = (n = h[c])[n.length - 1]),
            ...
            ne.test(n) && 'w' === s
              ? ((e || t) && (o = !0), 0 === r ? (o = !0) : (e = r))
              : re.test(n) && 'x' === s
                ? ((e || t || i) && (o = !0), a < 0 ? (o = !0) : (t = a))
                : !ne.test(n) || 'h' !== s || ((i || t) && (o = !0), 0 === r)
                  ? (o = !0)
                  : (i = r);
        o ||
          ((l.url = u),
    ...
    function z() {
      ...
      (c = setTimeout(z, 'loading' === e ? 200 : 999)),
        r.body && (_.fillImgs(), (B = B || Y.test(e))) && clearTimeout(c);
    }
    function oe() {
      var e = new Date() - W;
    ...
    e.console && console.warn,
        ...
        if (e.length) {
          var i,
            ...
            u =
              ...
              (u = d),
              (b = e[0].set),
              (b = w(u, (b = !b && u ? (b = y[_.ns].sets) && b[b.length - 1] : b))) &&
                ((u = _.makeUrl(u)), (y[_.ns].curSrc = u), (y[_.ns].curCan = b).res || x(b, b.set.sizes)),
              b);
          if (
            (u &&
              u.set === e[0].set &&
              ((o = U && !t.complete && u.res - 0.1 > c) || ((u.cached = !0), u.res >= c && (a = u))),
            !a)
          )
                ...
                a =
                  ...
                  (f =
                    'saveData' === T.algorithm
                      ? 2.7 < h
                        ? m + 1
                        : ((v = (p - m) * (g = Math.pow(h - 0.6, 1.5))), f && (v += 0.1 * g), h + v)
                      : 1 < m
                        ? Math.sqrt(h * p)
                        : h),
                  m < f)
      ...
      (_.setSrc = function (e, t) {
        (e.src = t.url),
          'image/svg+xml' === t.set.type &&
            ((t = e.style.width), (e.style.width = e.offsetWidth + 1 + 'px'), e.offsetWidth + 1) &&
            (e.style.width = t);
      }),
      (_.getSet = function (e) {
      ...
      (_.parseSets = function (e, t, i) {
        var s,
          ...
          l = e[_.ns];
        if (
          ((void 0 !== l.src && !i.src) || ((l.src = v.call(e, 'src')), l.src ? V.call(e, E, l.src) : X.call(e, E)),
          (void 0 !== l.srcset && !i.srcset && _.supSrcset && !e.srcset) ||
            ((s = v.call(e, 'srcset')), (l.srcset = s), (a = !0)),
          (l.sets = []),
          o)
        ) {
          (l.pic = !0), (i = t);
        ...
        l.srcset
          ? ((n = { srcset: l.srcset, sizes: v.call(e, 'sizes') }),
            ...
            (r = (F || l.src) && Q.test(l.srcset || '')) ||
              ...
              w(l.src, n) ||
              n.has1x ||
              ((n.srcset += ', ' + l.src), n.cands.push({ url: l.src, d: 1, set: n })))
          : l.src && l.sets.push({ srcset: l.src, sizes: null }),
          (l.curCan = null),
          (l.curSrc = void 0),
          (l.supported = !(o || (n && !_.supSrcset) || (r && !_.supSizes))),
          a && _.supSrcset && !l.supported && (s ? (V.call(e, G, s), (e.srcset = '')) : X.call(e, G)),
          l.supported &&
            !l.srcset &&
            ((!l.src && e.src) || e.src !== _.makeUrl(l.src)) &&
      ...
      (_.fillImg = function (e, t) {
        ...
        e[_.ns] || (e[_.ns] = {}),
          (i = e[_.ns]),
          (!s && i.evaled === a) ||
            ((i.parsed && !t.reevaluate) || _.parseSets(e, e.parentNode, t),
            i.supported
              ? (i.evaled = a)
              : ((s = e),
                (t = _.getSet(s)),
                (i = !1),
                'pending' !== t && ((i = a), t) && ((t = _.setRes(t)), _.applySetCandidate(t, s)),
                (s[_.ns].evaled = i)));
      }),
      (_.setupRun = function () {
        (L && !A && I === e.devicePixelRatio) ||
          ((A = !1),
          (I = e.devicePixelRatio),
          (M = {}),
          (P = {}),
          (_.DPR = I || 1),
          (O.width = Math.max(e.innerWidth || 0, y.clientWidth)),
          (O.height = Math.max(e.innerHeight || 0, y.clientHeight)),
          (O.vw = O.width / 100),
          (O.vh = O.height / 100),
          (a = [O.height, O.width, I].join('-')),
          (O.em = _.getEmValue()),
          (O.rem = O.em));
      }),
      _.supPicture
        ...
        : ((Y = e.attachEvent ? /d$|^c/ : /d$|^c|^i/),
          ...
          i(
            ...
            'resize',
            ((R = function () {
              (A = Math.max(e.innerWidth || 0, y.clientWidth) !== O.width || y.clientHeight !== d),
                (d = y.clientHeight),
                A && _.fillImgs();
            }),
            (o = 99),
    ...
    (function (e, t) {
      ...
      (Je = [
        {
          ...
          value: function (i) {
            ...
            return (
              R(i) || Q(i)
                ? (e = Array.from(document.querySelectorAll(Q(i) ? i : 'input[type="range"]')))
                : q(i)
                  ? (e = [i])
                  : Z(i)
                    ? (e = Array.from(i))
              ...
              return o.enabled && B(e)
                ? ((n = e.target),
                  ...
                  t +
                    ((n = (e / 100) * (i - t)),
                    (r = s) < 1
                      ? ((e = (e = ''.concat(r).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/))
                          ? Math.max(0, (e[1] ? e[1].length : 0) - (e[2] ? +e[2] : 0))
                          : 0),
                        parseFloat(n.toFixed(e)))
                      : Math.round(n / r) * r))
                : null;
            }
          },
      ...
      function o(e, t) {
        ...
        q(e) ? (this.element = e) : Q(e) && (this.element = document.querySelector(e)),
          q(this.element) && R(this.element.rangeTouch) && ((this.config = r({}, F, {}, t)), this.init());
      }
      ...
      function f(t = {}, ...e) {
        ...
        return s(i)
          ? (Object.keys(i).forEach((e) => {
              s(i[e])
                ? (Object.keys(t).includes(e) || Object.assign(t, { [e]: {} }), f(t[e], i[e]))
      ...
      const _e = {
        ...
        k = {
          ...
          pip: !(
            m.isIPhone ||
            (!d(x('video').webkitSetPresentationMode) &&
      ...
      function A(i, e, s, n = !1, r = !0, a = !1) {
        if (i && 'addEventListener' in i && !w(e) && d(s)) {
          e = e.split(' ');
          let t = a;
          Te && (t = { passive: r, capture: a }),
            e.forEach((e) => {
              this &&
                this.eventListeners &&
                n &&
                this.eventListeners.push({ element: i, type: e, callback: s, options: t }),
      ...
      function Le(e) {
        ...
        var [e, s] = Ie(i),
          n = (100 / e) * s;
        if (
          (Ae(`aspect-ratio: ${e}/` + s) ? (t.style.aspectRatio = e + '/' + s) : (t.style.paddingBottom = n + '%'),
      ...
      class He {
        constructor(e) {
          a(this, 'get', (e) => {
            var t;
            return !He.supported || !this.enabled || ((t = window.localStorage.getItem(this.key)), w(t))
              ? null
              : ((t = JSON.parse(t)), c(e) && e.length ? t[e] : t);
          }),
            a(this, 'set', (t) => {
        ...
        static get supported() {
          try {
            ...
            return 'localStorage' in window
              ? ((e = '___test'), window.localStorage.setItem(e, e), window.localStorage.removeItem(e), !0)
              : !1;
          } catch (e) {
            return !1;
          }
      ...
      const $ = {
        ...
        findElements() {
          try {
            return (
              (this.elements.controls = n.call(this, this.config.selectors.controls.wrapper)),
        ...
        createIcon(e, t) {
          var i = 'http://www.w3.org/2000/svg',
            ...
            i = s + '-' + e;
          return (
            'href' in t && t.setAttributeNS('http://www.w3.org/1999/xlink', 'href', i),
        ...
        createBadge(e) {
          ...
          return w(e)
            ? null
            : ((t = x('span', { class: this.config.classNames.menu.value })).appendChild(
        ...
        createButton(e, t) {
          ...
          switch (
            ...
            Object.keys(i).includes('class')
              ? i.class.split(' ').some((e) => e === this.config.classNames.control) ||
                f(i, { class: i.class + ' ' + this.config.classNames.control })
          ...
          return (
            n.toggle
              ? (t.appendChild($.createIcon.call(this, n.iconPressed, { class: 'icon--pressed' })),
                t.appendChild($.createIcon.call(this, n.icon, { class: 'icon--not-pressed' })),
                t.appendChild($.createLabel.call(this, n.labelPressed, { class: 'label--pressed' })),
                t.appendChild($.createLabel.call(this, n.label, { class: 'label--not-pressed' })))
              : (t.appendChild($.createIcon.call(this, n.icon)), t.appendChild($.createLabel.call(this, n.label))),
            f(i, _(this.config.selectors.buttons[s], i)),
            ge(t, i),
            'play' === s
              ? (u(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(t))
              : (this.elements.buttons[s] = t),
            t
          );
        },
        createRange(e, t) {
          t = x(
            'input',
            f(
              _(this.config.selectors.inputs[e]),
              {
                type: 'range',
                min: 0,
                max: 100,
        ...
        createProgress(e, t) {
          var i = x(
            'progress',
            f(
              _(this.config.selectors.display[e]),
                ...
                if (!i && ['Space', 'ArrowRight'].includes(t.key)) $.showMenuPanel.call(this, e, !0);
                  ...
                  'Space' !== t.key &&
                    ('ArrowDown' === t.key || (i && 'ArrowRight' === t.key)
                      ? ((e = s.nextElementSibling), b(e) || (e = s.parentNode.firstElementChild))
                      : ((e = s.previousElementSibling), b(e) || (e = s.parentNode.lastElementChild)),
                    xe.call(this, e, !0));
                }
              }
            },
        ...
        createMenuItem({ value: t, list: e, type: i, title: s, badge: n = null, checked: r = !1 }) {
          ...
          (l.innerHTML = s),
              ...
              set(e) {
                e &&
                  Array.from(o.parentNode.children)
                    .filter((e) => S(e, '[role="menuitemradio"]'))
            ...
            $.bindMenuItemShortcuts.call(this, o, i),
            e.appendChild(o);
        },
        formatTime(e = 0, t = !1) {
        ...
        updateVolume() {
          this.supported.ui &&
            (b(this.elements.inputs.volume) &&
              $.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            b(this.elements.buttons.mute)) &&
        ...
        updateSeekTooltip(t) {
          if (
            ...
            b(this.elements.inputs.seek) &&
            b(this.elements.display.seekTooltip) &&
            0 !== this.duration
          ) {
        ...
        durationUpdate() {
          ...
          !this.supported.ui ||
            ...
            (this.duration >= 2 ** 32
              ? (T(this.elements.display.currentTime, !0), T(this.elements.progress, !0))
              : (b(this.elements.inputs.seek) && this.elements.inputs.seek.setAttribute('aria-valuemax', this.duration),
                !(e = b(this.elements.display.duration)) &&
                  this.config.displayDuration &&
                  this.paused &&
                  $.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
        ...
        setCaptionsMenu() {
          if (b(this.elements.settings.panels.captions)) {
            const i = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
              ...
              s = Boolean(t.length);
            var e;
            $.toggleMenuButton.call(this, 'captions', s),
              ye(i),
              $.checkMenu.call(this),
              s &&
                ((e = t.map((e, t) => ({
                ...
                e.forEach($.createMenuItem.bind(this)),
        ...
        focusFirstMenuItem(t, i = !1) {
          if (!this.elements.settings.popup.hidden) {
            let e = t;
            t = (e = b(e) ? e : Object.values(this.elements.settings.panels).find((e) => !e.hidden)).querySelector(
              '[role^="menuitem"]'
            );
            xe.call(this, t, i);
          }
        ...
        toggleMenu(t) {
          ...
          if (b(i) && b(s)) {
            ...
            s.setAttribute('aria-expanded', e),
              ...
              e && p(t) ? $.focusFirstMenuItem.call(this, null, !0) : e || n || xe.call(this, s, p(t));
          }
        },
        getMenuSize(e) {
          var t = e.cloneNode(!0),
              ...
              const e = $.getMenuSize.call(this, i),
                t = (e) => {
                  e.target === s &&
                    ...
                    ((s.style.width = ''), (s.style.height = ''), Ee.call(this, s, he, t));
                };
        ...
        create(r) {
          ...
          return (
            Ce(u(this.config.controls) ? this.config.controls : []).forEach((t) => {
              if (
                ('restart' === t && c.appendChild(i.call(this, 'restart', d)),
                ...
                if (
                  (i.appendChild(s.call(this, 'seek', { id: 'plyr-seek-' + r.id })),
              ...
              if (
                ('current-time' === t && c.appendChild(o.call(this, 'currentTime', d)),
                ...
                if (
                  ((b(e) && c.contains(e)) ||
                    ((e = x('div', f({}, d, { class: (d.class + ' plyr__volume').trim() }))),
              ...
              if (
                ('captions' === t && c.appendChild(i.call(this, 'captions', d)),
                ...
                const e = x('div', f({}, d, { class: (d.class + ' plyr__menu').trim(), hidden: '' })),
                  ...
                  o = x('div'),
                  t = x('div', { id: `plyr-settings-${r.id}-home` }),
                  n = x('div', { role: 'menu' });
                t.appendChild(n),
                  o.appendChild(t),
                  ...
                  this.config.settings.forEach((e) => {
                    var t = x(
                        'button',
                        f(_(this.config.selectors.buttons.settings), {
                          type: 'button',
                      ...
                      s =
                        ...
                        t.appendChild(i),
                        n.appendChild(t),
                        x('div', { id: `plyr-settings-${r.id}-` + e, hidden: '' })),
                      i = x('button', {
                        type: 'button',
                        class: `${this.config.classNames.control} ${this.config.classNames.control}--back`
                      });
                    i.appendChild(x('span', { 'aria-hidden': !0 }, L.get(e, this.config))),
                      i.appendChild(
                        x('span', { class: this.config.classNames.hidden }, L.get('menuBack', this.config))
                      ),
                      M.call(
                        this,
                        s,
              ...
              if (
                ('pip' === t && k.pip && c.appendChild(i.call(this, 'pip', d)),
                ...
                !ue(a) && this.isEmbed && f(r, { icon: 'logo-' + this.provider, label: this.provider }),
                  c.appendChild(i.call(this, 'download', r));
              }
              'fullscreen' === t && c.appendChild(i.call(this, 'fullscreen', d));
            }),
            this.isHTML5 && t.call(this, O.getQualityOptions.call(this)),
            n.call(this),
            c
          );
        },
        inject() {
          ...
          d(this.config.controls) && (this.config.controls = this.config.controls.call(this, e)),
            ...
            b(this.config.controls) || c(this.config.controls)
          ...
          if (
            ...
            c(this.config.selectors.controls.container) &&
              (s = document.querySelector(this.config.selectors.controls.container)),
            (s = b(s) ? s : this.elements.container)[b(t) ? 'insertAdjacentElement' : 'insertAdjacentHTML'](
              'afterbegin',
              t
            ),
            b(this.elements.controls) || $.findElements.call(this),
          ...
          if (this.duration && !this.elements.markers) {
            ...
            if (null != e && e.length) {
              ...
              e.forEach((e) => {
                ...
                t.appendChild(n),
                this.config.tooltips.seek ||
                  ((s = x('span', { class: this.config.classNames.tooltip }, '')), t.appendChild(s)),
      ...
      const z = {
          setup() {
            if (this.supported.ui)
              if (!this.isVideo || this.isYouTube || (this.isHTML5 && !k.textTracks))
                ...
                var i;
                if (
                  (b(this.elements.captions) ||
                    ((this.elements.captions = x('div', _(this.config.selectors.captions))),
                ...
                if (
                  (y(t) || ({ active: t } = this.config.captions),
                  Object.assign(this.captions, { toggled: !1, active: t, language: e, languages: s }),
                  this.isHTML5)
                ) {
          ...
          update() {
            ...
            this.isHTML5 &&
              ...
              this.elements && E(this.elements.container, this.config.classNames.captions.enabled, !w(e)),
              u(this.config.controls) &&
                this.config.controls.includes('settings') &&
                this.config.settings.includes('captions') &&
                $.setCaptionsMenu.call(this);
              ...
              ? v(e)
                ? e in s
                  ? (this.captions.currentTrack !== e &&
                      ((i = ((s = s[(this.captions.currentTrack = e)]) || {})['language']),
                      (this.captions.currentTrackNode = s),
                      $.updateSetting.call(this, 'captions'),
                      t || ((this.captions.language = i), this.storage.set({ language: i })),
          ...
          setLanguage(e, t = !0) {
            ...
            c(e)
              ? ((s = e.toLowerCase()),
                ...
                (i = z.getTracks.call(this)),
                (s = z.findTrack.call(this, [s])),
                z.set.call(this, i.indexOf(s), t))
          ...
          getLabel(e) {
            let t = e;
            return (
              !de(t) && k.textTracks && this.captions.toggled && (t = z.getCurrentTrack.call(this)),
              de(t)
                ? w(t.label)
                  ? w(t.language)
      ...
      class j {
          ...
          a(this, 'onChange', () => {
            ...
            a(this, 'toggleFallback', (t = !1) => {
              if (
                ...
                E(this.target, this.player.config.classNames.fullscreen.fallback, t),
                m.isIos)
              ) {
            ...
            a(this, 'trapFocus', (e) => {
              ...
              !m.isIos &&
                ...
                ([i] = s = C.call(this.player, 'a[href], button:not(:disabled), input:not(:disabled), [tabindex]')),
                t !== (s = s[s.length - 1]) || e.shiftKey
                  ? t === i && e.shiftKey && (s.focus(), e.preventDefault())
                  : (i.focus(), e.preventDefault()));
            }),
            a(this, 'update', () => {
              var e;
              this.enabled
                ? ((e = this.forceFallback ? 'Fallback (forced)' : j.native ? 'Native' : 'Fallback'),
                  this.player.debug.log(e + ' fullscreen enabled'))
                : this.player.debug.log('Fullscreen not supported and fallback disabled'),
                E(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.enabled);
            }),
            a(this, 'enter', () => {
              this.enabled &&
            ...
            a(this, 'exit', () => {
              ...
              this.enabled &&
                (m.isIos && this.player.config.fullscreen.iosNative
                  ? (this.target.webkitExitFullscreen(), I(this.player.play()))
                  : !j.native || this.forceFallback
                    ? this.toggleFallback(!1)
                    : this.prefix
                      ? w(this.prefix) ||
                        ((e = 'moz' === this.prefix ? 'Cancel' : 'Exit'), document[this.prefix + e + this.property]())
            ...
            M.call(this.player, this.player.elements.container, 'dblclick', (e) => {
              (b(this.player.elements.controls) && this.player.elements.controls.contains(e.target)) ||
        ...
        static get prefix() {
          ...
          return (
            ['webkit', 'moz', 'ms'].some(
              (e) => !((!d(document[e + 'ExitFullscreen']) && !d(document[e + 'CancelFullScreen'])) || ((t = e), 0))
            ),
            t
          );
        }
        ...
        get enabled() {
          return (
            (j.native || this.player.config.fullscreen.fallback) &&
        ...
        get active() {
          ...
          return (
            !!this.enabled &&
            (!j.native || this.forceFallback
              ? we(this.target, this.player.config.classNames.fullscreen.fallback)
              : (e = this.prefix
                    ? this.target.getRootNode()['' + this.prefix + this.property + 'Element']
                    : this.target.getRootNode().fullscreenElement) && e.shadowRoot
      ...
      const N = {
        addStyleHook() {
          E(this.elements.container, this.config.selectors.container.replace('.', ''), !0),
            E(this.elements.container, this.config.classNames.uiSupported, this.supported.ui);
        },
        ...
        build() {
          this.listeners.media(),
            this.supported.ui
              ? (b(this.elements.controls) || ($.inject.call(this), this.listeners.controls()),
                ...
                E(this.elements.container, this.config.classNames.pip.supported, k.pip && this.isHTML5 && this.isVideo),
                E(this.elements.container, this.config.classNames.airplay.supported, k.airplay && this.isHTML5),
                E(this.elements.container, this.config.classNames.isIos, m.isIos),
                E(this.elements.container, this.config.classNames.isTouch, this.touch),
                (this.ready = !0),
                setTimeout(() => {
              ...
              : (this.debug.warn(`Basic support only for ${this.provider} ` + this.type),
                N.toggleNativeControls.call(this, !0));
        },
        setTitle() {
          let t = L.get('play', this.config);
          if (
            (c(this.config.title) && !w(this.config.title) && (t += ', ' + this.config.title),
            ...
            var e, i;
            b(t) &&
              ((e = w(this.config.title) ? 'video' : this.config.title),
            ...
            : (this.media.setAttribute('data-poster', t),
              ...
              function () {
                return new Promise((e) =>
                  this.ready ? setTimeout(e, 0) : M.call(this, this.elements.container, 'ready', e)
                ).then(() => {});
              }
                .call(this)
                .then(() => Ke(t))
                ...
                .then(
                  () => (
                    Object.assign(this.elements.poster.style, { backgroundImage: `url('${t}')`, backgroundSize: '' }),
        ...
        checkPlaying(e) {
          E(this.elements.container, this.config.classNames.playing, this.playing),
            E(this.elements.container, this.config.classNames.paused, this.paused),
            E(this.elements.container, this.config.classNames.stopped, this.stopped),
            Array.from(this.elements.buttons.play || []).forEach((e) => {
        ...
        migrateStyles() {
          Object.values({ ...this.media.style })
            .filter((e) => !w(e) && c(e) && e.startsWith('--plyr'))
            .forEach((e) => {
          ...
          a(this, 'firstTouch', () => {
            ...
            a(this, 'setTabFocus', (e) => {
              ...
              clearTimeout(this.focusTimer),
                ('keydown' === n && 'Tab' !== s) ||
                  ('keydown' === n && (this.lastKeyDown = r), (e = r - this.lastKeyDown <= 20), 'focus' === n && !e) ||
                  ((e = t.config.classNames.tabFocus), E(C.call(t, '.' + e), e, !1), 'focusout' === n) ||
            ...
            a(this, 'container', () => {
              const a = this['player'],
                { config: e, elements: o, timers: s } = a,
                i =
                  (!e.keyboard.global &&
                    e.keyboard.focused &&
                    M.call(a, o.container, 'keydown keyup', this.handleKey, !1),
                  M.call(
                    a,
                    o.container,
                    ...
                    (e) => {
                      ...
                      ['touchstart', 'touchmove', 'mousemove'].includes(e.type) &&
                        (N.toggleControls.call(a, !0), (i = a.touch ? 3e3 : 2e3)),
                  ...
                  () => {
                    var e, t, i, s, n, r;
                    a.isVimeo &&
                      !a.config.vimeo.premium &&
                      ((e = o.wrapper),
                      (r = a.fullscreen['active']),
                      ([t, i] = Oe.call(a)),
                      (s = Ae(`aspect-ratio: ${t} / ` + i)),
                      r
                        ? (([r, n] = [
                          ...
                          (r = t / i < r / n),
                          s
                            ? ((e.style.width = r ? 'auto' : '100%'), (e.style.height = r ? '100%' : 'auto'))
                            : ((e.style.maxWidth = r ? (n / i) * t + 'px' : null),
                              (e.style.margin = r ? '0 auto' : null)))
                        : s
              ...
              M.call(a, o.container, 'enterfullscreen exitfullscreen', (e) => {
                ...
                t !== o.container ||
                  ...
                  (i(), ('enterfullscreen' === e.type ? M : Ee).call(a, window, 'resize', n));
              });
            }),
            a(this, 'media', () => {
              const i = this['player'],
            ...
            a(this, 'controls', () => {
              ...
              if (
                ...
                this.bind(s.buttons.restart, 'click', a.restart, 'restart'),
                this.bind(
                  s.buttons.rewind,
                  'click',
                  () => {
                ...
                this.bind(s.buttons.captions, 'click', () => a.toggleCaptions()),
                this.bind(
                  s.buttons.download,
                  'click',
                  () => {
                ...
                this.bind(s.buttons.airplay, 'click', a.airplay, 'airplay'),
                this.bind(
                  s.buttons.settings,
                  'click',
                  (e) => {
                ...
                this.bind(
                  ...
                  (e) => {
                    ['Space', 'Enter'].includes(e.key) &&
                      ('Enter' !== e.key
                        ? (e.preventDefault(), e.stopPropagation(), $.toggleMenu.call(a, e))
                        : $.focusFirstMenuItem.call(a, null, !0));
                  },
                  null,
                  !1
                ),
                ...
                this.bind(s.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', (e) => {
                  var t,
                    i = e.currentTarget,
                    s = 'play-on-seeked';
                  (p(e) && !['ArrowLeft', 'ArrowRight'].includes(e.key)) ||
                    ((a.lastSeekTime = Date.now()),
                    (t = i.hasAttribute(s)),
                    (e = ['mouseup', 'touchend', 'keyup'].includes(e.type)),
                    t && e
                      ? (i.removeAttribute(s), I(a.play()))
                      : !e && a.playing && (i.setAttribute(s, ''), a.pause()));
                }),
                m.isIos)
              ) {
              ...
              this.bind(
                ...
                this.bind(s.progress, 'mouseenter mouseleave mousemove', (e) => $.updateSeekTooltip.call(a, e)),
                ...
                (a = a || 0),
                  /(^css!|\.css$)/.test(u)
                    ? (((l = e.createElement('link')).rel = 'stylesheet'),
                      (l.href = h),
                      (o = 'hideFocus' in l) && l.relList && ((o = 0), (l.rel = 'preload'), (l.as = 'style')))
                    : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(u)
                      ? ((l = e.createElement('img')).src = h)
                      : (((l = e.createElement('script')).src = s), (l.async = void 0 === t || t)),
                  (l.onload =
                    l.onerror =
                    l.onbeforeload =
                      function (e) {
          ...
          return (
            (m.ready = function (e, t) {
              ...
              for (
                ...
                (n = i[o]), (r = d[n]) ? c(n, r) : (u[n] = u[n] || []).push(c);
              return m;
            }),
            (m.done = function (e) {
              o(e, []);
      ...
      function it(e) {
        e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
          this.media.paused === e && ((this.media.paused = !e), P.call(this, this.media, e ? 'play' : 'pause'));
      }
      const st = {
        setup() {
          const t = this;
        ...
        ready() {
          ...
          let n = a.media.getAttribute('src'),
            r = '';
          var o = (r = w(n)
              ? ((n = a.media.getAttribute(a.config.attributes.embed.id)),
                a.media.getAttribute(a.config.attributes.embed.hash))
              : (o = n.match(/^.*(vimeo.com\/|video\/)(\d+)(\?.*&*h=|\/)+([\d,a-f]+)/)) && 5 === o.length
                ? o[4]
                : null)
              ? { h: r }
              : {},
          ...
          if (
            ...
            d.setAttribute('data-poster', a.poster), (a.media = be(d, a.media));
          else {
            const e = x('div', { class: a.config.classNames.embedContainer, 'data-poster': a.poster });
            e.appendChild(d), (a.media = be(e, a.media));
          }
          e.customControls ||
            qe(ze(a.config.urls.vimeo.api, c)).then((e) => {
              !w(e) && e.thumbnail_url && N.setPoster.call(a, e.thumbnail_url).catch(() => {});
            }),
            (a.embed = new window.Vimeo.Player(d, { autopause: a.config.autopause, muted: a.muted })),
            (a.media.paused = !0),
            (a.media.currentTime = 0),
            a.supported.ui && a.embed.disableTextTrack(),
            (a.media.play = () => (it.call(a, !0), a.embed.play())),
            (a.media.pause = () => (it.call(a, !1), a.embed.pause())),
            (a.media.stop = () => {
          ...
          let u = a.media['currentTime'],
            h =
              (Object.defineProperty(a.media, 'currentTime', {
                get: () => u,
                set(e) {
                  const { embed: t, media: i, paused: s, volume: n } = a,
                    r = s && !t.hasPlayed;
                  (i.seeking = !0),
                    P.call(a, i, 'seeking'),
          ...
          Object.defineProperty(a.media, 'loop', {
            ...
            Object.defineProperty(a.media, 'currentSrc', { get: () => f }),
            Object.defineProperty(a.media, 'ended', { get: () => a.currentTime === a.duration }),
            ...
            a.embed.on('progress', (e) => {
              (a.media.buffered = e.percent),
                P.call(a, a.media, 'progress'),
                1 === parseInt(e.percent, 10) && P.call(a, a.media, 'canplaythrough'),
                a.embed.getDuration().then((e) => {
      ...
      const rt = {
          setup() {
            if ((E(this.elements.wrapper, this.config.classNames.embed, !0), s(window.YT) && d(window.YT.Player)))
              rt.ready.call(this);
            else {
          ...
          ready() {
            ...
            if (w(e) || !e.startsWith('youtube-')) {
              ...
              const a = w((t = e))
                ? null
                : t.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/)
                  ? RegExp.$2
                  : t;
              var t = x('div', {
              ...
              if (((n.media = be(t, n.media)), r.customControls)) {
                ...
                Ke(r('maxres'), 121)
                  .catch(() => Ke(r('sd'), 121))
                  .catch(() => Ke(r('hq')))
                  .then((e) => N.setPoster.call(n, e.src))
                  .then((e) => {
                ...
                events: {
                  onError(e) {
                    ...
                    n.media.error ||
                      ...
                      (n.media.error = { code: e, message: t }),
                  ...
                  onReady(e) {
                    if (!d(n.media.play)) {
                      ...
                      Object.defineProperty(n.media, 'muted', {
                        ...
                        Object.defineProperty(n.media, 'currentSrc', { get: () => s.getVideoUrl() }),
                        Object.defineProperty(n.media, 'ended', { get: () => n.currentTime === n.duration });
                      ...
                      (n.options.speed = e.filter((e) => n.config.speed.options.includes(e))),
                        ...
                        (n.timers.buffering = setInterval(() => {
                          (n.media.buffered = s.getVideoLoadedFraction()),
                            (null === n.media.lastBuffered || n.media.lastBuffered < n.media.buffered) &&
                              P.call(n, n.media, 'progress'),
                            (n.media.lastBuffered = n.media.buffered),
                            1 === n.media.buffered &&
                              (clearInterval(n.timers.buffering), P.call(n, n.media, 'canplaythrough'));
                        }, 200)),
                        r.customControls && setTimeout(() => N.build.call(n), 50);
                    }
                  },
                  onStateChange(e) {
                    var t = e.target;
                    switch (
                      ...
                      n.media.seeking &&
                        [1, 2].includes(e.data) &&
                        ((n.media.seeking = !1), P.call(n, n.media, 'seeked')),
                      e.data)
                    ) {
                      case -1:
                        P.call(n, n.media, 'timeupdate'),
                      ...
                      case 0:
                        ...
                        break;
                      case 1:
                        r.customControls && !n.config.autoplay && n.media.paused && !n.embed.hasPlayed
                          ? n.media.pause()
                          : (nt.call(n, !0),
                            ...
                            n.media.duration !== t.getDuration() &&
                              ((n.media.duration = t.getDuration()), P.call(n, n.media, 'durationchange')));
                        break;
                      case 2:
        ...
        at = {
          setup() {
            this.media
              ? (E(this.elements.container, this.config.classNames.type.replace('{0}', this.type), !0),
                E(this.elements.container, this.config.classNames.provider.replace('{0}', this.provider), !0),
                this.isEmbed && E(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
                this.isVideo &&
                  ((this.elements.wrapper = x('div', { class: this.config.classNames.video })),
                  fe(this.media, this.elements.wrapper),
                  (this.elements.poster = x('div', { class: this.config.classNames.poster })),
      ...
      class ot {
        constructor(e) {
          a(this, 'load', () => {
            ...
            a(this, 'setupIMA', () => {
              (this.elements.container = x('div', { class: this.player.config.classNames.ads })),
              ...
              w(this.cuePoints) ||
                this.cuePoints.forEach((e) => {
                  ...
                  0 !== e &&
                    ...
                    ((t = this.player.elements.progress), b(t)) &&
                    ((e = (100 / this.player.duration) * e),
                    ((i = x('span', { class: this.player.config.classNames.cues })).style.left = e.toString() + '%'),
                    t.appendChild(i));
                });
            }),
            a(this, 'onAdEvent', (e) => {
              ...
              switch (
                ...
                case google.ima.AdEvent.Type.LOADED:
                  this.trigger('loaded'),
                    ...
                    s.isLinear() || ((s.width = i.offsetWidth), (s.height = i.offsetHeight));
                  break;
            ...
            a(this, 'on', (e, t) => (u(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)),
          ...
          a(this, 'load', () => {
                    ...
                    const t = {
                            ...
                            e.split(/\r\n\r\n|\n\n|\r\r/).forEach((e) => {
                              ...
                              e.split(/\r\n|\n|\r/).forEach((e) => {
                                ...
                                v(i.startTime)
                                  ? !w(e.trim()) &&
                                    w(i.text) &&
                                    ((t = e.trim().split('#xywh=')), ([i.text] = t), t[1]) &&
                      ...
                      i =
                        (t.frames[0].text.startsWith('/') ||
                          ...
                          (t.urlPrefix = n.substring(0, n.lastIndexOf('/') + 1)),
                        new Image());
                    (i.onload = () => {
            ...
            a(this, 'startMove', (e) => {
              ...
              this.loaded &&
                ...
                ('touchmove' === e.type
                  ...
                  : ((t =
                      (100 / (t = this.player.elements.progress.getBoundingClientRect()).width) * (e.pageX - t.left)),
                    ...
                    (t =
                      null == (t = this.player.config.markers) || null == (e = t.points)
                        ? void 0
                        : e.find(({ time: e }) => e === Math.round(this.seekTime))) &&
                      this.elements.thumb.time.insertAdjacentHTML('afterbegin', t.label + '<br>')),
            ...
            a(this, 'startScrubbing', (e) => {
              (l(e.button) || !1 === e.button || 0 === e.button) &&
                ((this.mouseDown = !0), this.player.media.duration) &&
            ...
            a(this, 'render', () => {
              ...
              (this.elements.thumb.time = x('span', {}, '00:00')),
                ...
                b(this.player.elements.progress) &&
                ...
                (e = this.usingSprites ? s.h : e) < this.thumbContainerHeight &&
                  setTimeout(() => {
                    this.showingThumbFilename === n &&
                      (this.player.debug.log('Showing higher quality thumb for: ' + n), this.loadImage(t + 1));
                  }, 300);
              }
            }),
            ...
            a(this, 'setThumbContainerSizeAndPos', () => {
              var e,
                t = this.elements.thumb['imageContainer'];
              this.sizeSpecifiedInCSS
                ? 20 < t.clientHeight && t.clientWidth < 20
                  ? ((e = Math.floor(t.clientHeight * this.thumbAspectRatio)), (t.style.width = e + 'px'))
                  : t.clientHeight < 20 &&
                    20 < t.clientWidth &&
                    ((e = Math.floor(t.clientWidth / this.thumbAspectRatio)), (t.style.height = e + 'px'))
                : ((e = Math.floor(this.thumbContainerHeight * this.thumbAspectRatio)),
      ...
      class ht {
          ...
          if (
            (a(this, 'play', () =>
              d(this.media.play)
                ? (this.ads &&
                    this.ads.enabled &&
                    this.ads.managerPromise.then(() => this.ads.play()).catch(() => I(this.media.play())),
                  this.media.play())
                : null
            ),
            a(this, 'pause', () => (this.playing && d(this.media.pause) ? this.media.pause() : null)),
            a(this, 'togglePlay', (e) => ((y(e) ? e : !this.playing) ? this.play() : this.pause())),
            a(this, 'stop', () => {
            ...
            a(this, 'destroy', (e, t = !1) => {
              ...
              this.ready &&
                ...
                this.isHTML5
                  ? (N.toggleNativeControls.call(this, !0), i())
                  : this.isYouTube
            ...
            ((window.jQuery && this.media instanceof jQuery) || ce(this.media) || u(this.media)) &&
              ...
              switch (s) {
                case 'div':
                  if (((n = this.media.querySelector('iframe')), b(n))) {
                    if (
                      ((r = Ye(n.getAttribute('src'))),
                      (this.provider =
                        ((i = r.toString()),
                        /^(https?:\/\/)?(www\.)?(youtube\.com|youtube-nocookie\.com|youtu\.?be)\/.+$/.test(i)
                          ? D.youtube
                          : /^https?:\/\/player.vimeo.com\/video\/\d{0,9}(?=\b|\/)/.test(i)
                            ? D.vimeo
                            : null)),
                      ...
                      const a = ['1', 'true'];
                      a.includes(r.searchParams.get('autoplay')) && (this.config.autoplay = !0),
                        a.includes(r.searchParams.get('loop')) && (this.config.loop.active = !0),
                        this.isYouTube
                          ? ((this.config.playsinline = a.includes(r.searchParams.get('playsinline'))),
                  ...
                  if (w(this.provider) || !Object.values(D).includes(this.provider))
              ...
              (this.supported = k.check(this.type, this.provider, this.config.playsinline)),
                this.supported.api
                  ? ((this.eventListeners = []),
                    ...
                    b(this.elements.container) ||
                      ((this.elements.container = x('div', { tabindex: 0 })), fe(this.media, this.elements.container)),
        ...
        set poster(e) {
          this.isVideo
            ? N.setPoster.call(this, e, !1).catch(() => {})
        ...
        set ratio(e) {
          this.isVideo
            ? c(e) && Pe(e)
              ? ((this.config.ratio = Ie(e)), Le.call(this))
        ...
        set pip(e) {
          k.pip &&
            ...
            (!this.pip && e ? this.media.requestPictureInPicture() : this.pip && !e && document.exitPictureInPicture());
        }
        get pip() {
          return k.pip
...
var _self =
  ...
  Prism = (function (l) {
          ...
          var s = $.util.getLanguage(e),
            ...
            a =
              (r &&
                ...
                (r.className = r.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + s),
                ...
                a.grammar
                  ? t && l.Worker
                    ? (((s = new Worker($.filename)).onmessage = function (e) {
                      ...
                      s.postMessage(JSON.stringify({ language: a.language, code: a.code, immediateClose: !0 })))
                    : o($.highlight(a.code, a.grammar, a.language))
                  : o($.util.encode(a.code)))
              : ($.hooks.run('complete', a), i && i.call(a.element));
        },
                          ...
                          if (!(b instanceof z)) {
                            ...
                            for (
                              var _ = w.index,
                                C = w[0],
                                k = b.slice(0, _),
                                A = b.slice(_ + C.length),
                                b = y + b.length,
                                M = (a && b > a.reach && (a.reach = b), v.prev),
                                P = (k && ((M = j(i, M, k)), (y += k.length)), (L = O = I = k = P = void 0), i),
                                k = M,
                                I = x,
                                O = k.next,
                                L = 0;
                            ...
                            A && j(i, v, A),
                              1 < x &&
                                (e(t, i, s, v.prev, y, (k = { cause: o + ',' + c, reach: b })), a) &&
                                k.reach > a.reach &&
                                (a.reach = k.reach);
                          }
                        }
    ...
    return (
      ...
      l.document)
        ? ((i = $.util.currentScript()) && (($.filename = i.src), i.hasAttribute('data-manual')) && ($.manual = !0),
          $.manual ||
            ('loading' === (e = document.readyState) || ('interactive' === e && i && i.defer)
              ...
              (function e(t) {
                for (var i = 0; i < t.length && !(u >= h.length); i++) {
                  ...
                  'string' == typeof l || (l.content && 'string' == typeof l.content)
                    ? ((s = h[u]),
                      (r = c.tokenStack[s]),
                      (a = 'string' == typeof l ? l : l.content),
                      (s = m(d, s)),
                      -1 < (o = a.indexOf(s)) &&
                        (++u,
                        (n = a.substring(0, o)),
                        (r = new p.Token(d, p.tokenize(r, c.grammar), 'language-' + d, r)),
                        (a = a.substring(o + s.length)),
                        (o = []),
                        n && o.push.apply(o, e([n])),
                        o.push(r),
                        a && o.push.apply(o, e([a])),
                        'string' == typeof l ? t.splice.apply(t, [i, 1].concat(o)) : (l.content = o)))
    ...
    !(function (e) {
      (e.languages.sass = e.languages.extend('css', {
        ...
        e.languages.insertBefore('sass', 'atrule', {
          'atrule-line': { pattern: /^(?:[ \t]*)[@+=].+/m, greedy: !0, inside: { atrule: /(?:@[\w-]+|[+=])/m } }
        }),
              ...
              !function () {
                var c,
                  ...
                  p = (function () {
                    ...
                    function u(e, t, i, s, n, r, a) {
                      ...
                      for (o in t)
                        t.hasOwnProperty(o) &&
                          ((l = a[o]), (l = 'function' == typeof l ? l : p[l]), (t[o] = d(i[o], s[o], l, c)));
                      return t;
                    }
                    function d(e, t, i, s) {
                      return e + (t - e) * i(s);
                    ...
                    function l(e, t, i, s, n, r, a, o, l, c, d) {
                      (g = t + i + s),
                        ...
                        e.isPlaying() &&
                          (f
                            ? (l(a, e._attachment, g), e.stop(!0))
                            : ((e._scheduleId = c(e._timeoutHandler, 1e3 / 60)),
                              h(e, 'beforeTween'),
                              m < t + i ? u(1, n, r, a, 1, 1, o) : u(m, n, r, a, s, t + i, o),
                              h(e, 'afterTween'),
                              l(n, e._attachment, g)));
                    }
                    function c(e, t) {
                    ...
                    return (
                      ...
                      (e.prototype.resume = function () {
                        return (
                          this._isPaused && (this._timestamp += v() - this._pausedAtTime),
                          (this._isPaused = !1),
                          (this._isTweening = !0),
                    ...
                    c.each(n, function (e) {
                      ...
                      'string' == typeof s &&
                        ...
                        (r[e] = {
                          formatString:
                            ((i = (s = s).match(o))
                              ? (1 !== i.length && !s[0].match(a)) || i.unshift('')
                              : (i = ['', '']),
                            i.join(d)),
                ...
                p.shallowCopy(p.prototype.formula, {
                  ...
                  (p.setBezierFunction = function (e, t, i, s, n) {
                    ...
                    return (
                      (c.displayName = e), (c.x1 = t), (c.y1 = i), (c.x2 = s), (c.y2 = n), (p.prototype.formula[e] = c)
                    );
                  }),
                  ...
                  (r = /[0-9.\-]+/g),
                  (n = new RegExp(
                    'rgb\\(' + r.source + /,\s*/.source + r.source + /,\s*/.source + r.source + '\\)',
                    'g'
                  )),
                  (l = /^.*\(/),
                  (s = /#([0-9]|[a-f]){3,6}/gi),
          ...
          5: [
            function (e, t, i) {
              function s(e, t) {
                ...
                (t = l.extend({ duration: 800, easing: 'linear', from: {}, to: {}, step: function () {} }, t)),
                ...
                (s.prototype._initializeTextContainer = function (e, t, i) {
                  e.text.style &&
                    ...
                    e.text.alignToBottom
                      ? a.setStyle(i, 'transform', 'translate(-50%, 0)')
                      : a.setStyle(i, 'transform', 'translate(-50%, 50%)'));
                }),
              ...
              function n(e, t) {
                ...
                if (0 !== arguments.length) {
                  (this._opts = a.extend(
                    ...
                    a.isObject(t) && void 0 !== t.svgStyle && (this._opts.svgStyle = t.svgStyle),
                    a.isObject(t) &&
                      a.isObject(t.text) &&
                      void 0 !== t.text.style &&
                  ...
                  (this._container = s),
                    ...
                    this._opts.svgStyle && a.setStyles(i.svg, this._opts.svgStyle),
                    (this.svg = i.svg),
                    (this.path = i.path),
                    (this.trail = i.trail),
                    (this.text = null);
              ...
              (n.prototype.animate = function (e, t, i) {
                ...
                (n.prototype.setText = function (e) {
                  ...
                  null === this.text &&
                    ...
                    a.isObject(e) ? (a.removeChildren(this.text), this.text.appendChild(e)) : (this.text.innerHTML = e);
                }),
              ...
              t.exports = {
                extend: function e(t, i, s) {
                  for (var n in ((t = t || {}), (s = s || !1), (i = i || {}))) {
                    var r, a;
                    i.hasOwnProperty(n) &&
                      ((r = t[n]), (a = i[n]), s && o(r) && o(a) ? (t[n] = e(r, a, s)) : (t[n] = a));
                  }
                  return t;
                },
                render: function (e, t) {
                  ...
                  for (i in t)
                    t.hasOwnProperty(i) &&
                      ((s = t[i]), (n = new RegExp('\\{' + i + '\\}', 'g')), (r = r.replace(n, s)));
                  return r;
                },
                setStyle: s,
          ...
          function A() {
            ...
            for (
              ...
              var t = void 0,
                ...
                w = !0,
                x =
                  (r || a || o || l ? (t = { xs: r, sm: a, md: o, lg: l }) : (w = !1),
                  (r = T.options.wrapper
                ...
                _ =
                  T.options.horizontal && (s || T.options.center)
                    ? T.options.wrapper
            ...
            O = function () {
              P() && !1 === k
                ...
                : ((s = null),
                  ...
                  (T.options.wrapper || window).addEventListener('scroll', d, !!n && { passive: !0 }),
                  (T.options.wrapper || document).addEventListener('touchmove', d, !!n && { passive: !0 }));
            },
            L = function () {
              for (var e = 0; e < T.elems.length; e++) {
                ...
                (i =
                  ...
                  (t = s.x - C[e].baseX),
                  null !== C[e].min &&
                    (T.options.vertical && !T.options.horizontal && (i = i <= C[e].min ? C[e].min : i),
                  ...
                  null !== C[e].max &&
                    (T.options.vertical && !T.options.horizontal && (i = i >= C[e].max ? C[e].max : i),
                    T.options.horizontal) &&
                    !T.options.vertical &&
    ...
    !(function (e, t) {
      ...
      (i.prototype.init = function () {
        ...
        (i.prototype.start = function () {
          !0 !== this.running && ((this.running = !0), this.changeWord(this.words[this.position]), this.position++),
        ...
        (i.prototype.changeWord = function (e) {
          this.element.innerHTML =
            '<span class="' + this.options.animation + '" style="display:inline-block;">' + e + '</span>';
        }),
  ...
  scrollCue =
    ...
    ($jscomp.polyfillUnisolated = function (e, t, i, s) {
      ...
      (t = t((s = i[(e = e[e.length - 1])]))) != s &&
        null != t &&
        $jscomp.defineProperty(i, e, { configurable: !0, writable: !0, value: t });
    }),
    ($jscomp.polyfillIsolated = function (e, t, i, s) {
      ...
      (n = n[n.length - 1]),
        null != (t = t((i = $jscomp.IS_SYMBOL_NATIVE && 'es6' === i ? s[n] : null))) &&
          (e
            ? $jscomp.defineProperty($jscomp.polyfills, n, { configurable: !0, writable: !0, value: t })
            : t !== i &&
              ...
              $jscomp.defineProperty(s, n, { configurable: !0, writable: !0, value: t })));
    }),
      ...
      var r,
        ...
        o = {
              ...
              return (
                Object.keys(t).forEach(function (e) {
                  '[object Object]' === Object.prototype.toString.call(t[e])
                    ...
                    : ((s[e] = t[e]), void 0 !== i && void 0 !== i[e] && (s[e] = i[e]));
                }),
                s
              );
          },
          searchElements: function () {
            ...
            if (d)
              for (e = docSlider.getElements().pages.length, t = 0; t < e; t++)
                for (
                  i = document.querySelectorAll('[data-ds-index="' + t + '"] [data-cue]:not([data-scpage])'), s = 0;
                  s < i.length;
                  s++
                )
          ...
          sortElements: function () {
            for (
              var e = arguments[0], r = [].slice.call(arguments).slice(1), t = { $jscomp$loop$prop$i$4: 0 };
              t.$jscomp$loop$prop$i$4 < r.length;
              (t = { $jscomp$loop$prop$i$4: t.$jscomp$loop$prop$i$4 }).$jscomp$loop$prop$i$4++
            )
              e.sort(
                (function (n) {
                  return function (e, t) {
          ...
          setDurationValue: function (e, t, i) {
            return void 0 !== t &&
              ((t = t.duration), (e = -1 === (i + '').indexOf('.') ? e + t + i : e + t + t * i) < 0)
              ? 0
              : e;
          },
            ...
            for (
              ...
              if (((t.$jscomp$loop$prop$elms$6 = n[e[i]]), o.isElementIn(t.$jscomp$loop$prop$elms$6[0].elm))) {
                'reverse' === t.$jscomp$loop$prop$elms$6[0].sort
                  ...
                  : 'random' === t.$jscomp$loop$prop$elms$6[0].sort && o.randElements(t.$jscomp$loop$prop$elms$6),
                    ...
                    return function (e) {
                      t.$jscomp$loop$prop$elms$6[e].elm.setAttribute('data-show', 'true'),
                        ...
                        (t.$jscomp$loop$prop$elms$6[e].elm.style.animationDelay =
                          t.$jscomp$loop$prop$interval$7 + t.$jscomp$loop$prop$elms$6[e].delay + 'ms'),
...
function polyfill() {
  ...
  function h(e) {
    for (
      ;
      e !== d.body && !1 === ((i = void 0), (i = r((t = e), 'Y') && a(t, 'Y')), (t = r(t, 'X') && a(t, 'X')), i || t);
  ...
  function m(e, t, i) {
    var s,
      ...
      e =
        e === d.body
          ? ((n = (s = c).scrollX || c.pageXOffset), (r = c.scrollY || c.pageYOffset), o.scroll)
        ...
        void 0 !== arguments[0] &&
          (!0 === n(arguments[0])
            ...
            : m.call(
                c,
                d.body,
                void 0 !== arguments[0].left ? ~~arguments[0].left : c.scrollX || c.pageXOffset,
                void 0 !== arguments[0].top ? ~~arguments[0].top : c.scrollY || c.pageYOffset
              ));
      }),
    (c.scrollBy = function () {
      void 0 !== arguments[0] &&
    ...
    (e.prototype.scrollIntoView = function () {
      ...
      !0 === n(arguments[0])
        ...
        : ((t = (e = h(this)).getBoundingClientRect()),
          ...
          e !== d.body
            ? (m.call(this, e, e.scrollLeft + i.left - t.left, e.scrollTop + i.top - t.top),
              ...
              -1 == q.indexOf(u) &&
                ...
                u == m
                  ? ((d = r.firstElementChild) && d.localName.toLowerCase() == m
                      ? (c = d)
                      : ((c = h[p + 'NS']('http://www.w3.org/2000/svg', m)), r.insertBefore(c, d)),
                    (c.textContent = a))
                  : r[x](u, a));
            }
          }
    ...
    var e = (function e(t, i) {
          ...
          if (t) Array.isArray(t) ? t.push(e) : e();
            ...
            (u = function (e, t) {
              var i,
                ...
                s = a.afterLoad;
              s && (s = s(e, t) || e) && ((t = (i = 'string' == typeof s) ? s : I(e)), (e = i ? $(s, !0) : s)),
                e instanceof SVGElement
                  ? ((i = T), d && (i = O(e, !1)), c && ((s = i && I(e)), n([i, t, s])), L(r, e, l, a))
                  : (D(r, a), n(C)),
                o();
            }),
              (h = function () {
              ...
              (t = l) &&
                (((p = new XMLHttpRequest()).onreadystatechange = function () {
                  var e;
                  4 == p.readyState &&
                    (200 == (e = p.status) ? u(p.responseXML, p.responseText.trim()) : (400 <= e || 0 == e) && h());
                }),
                p.open('GET', t, !0),
                p.send());
          }
      ...
      return (
        A &&
          ...
          (n = h[y]('head')[0]) &&
            (((s = h[p](w)).type = 'text/css'), s.appendChild(h.createTextNode(i)), n.appendChild(s))),
  ...
  (function (e, t) {
    ...
    const i = {
          ...
          if (n)
            for (d = 0; d < c.length; d += 1) {
              ...
              i.dom7LiveListeners || (i.dom7LiveListeners = {}),
                ...
                i.dom7LiveListeners[t].push({ listener: r, proxyListener: o }),
            ...
            for (d = 0; d < c.length; d += 1) {
              ...
              i.dom7Listeners || (i.dom7Listeners = {}),
                ...
                i.dom7Listeners[t].push({ listener: r, proxyListener: l }),
          ...
          for (let e = 0; e < this.length; e += 1) {
            ...
            if (
              ...
              for (let e = t.length - 1; 0 <= e; --e) {
                const n = t[e];
                ((r && n.listener === r) ||
                  (r && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === r) ||
                  !r) &&
                  (s.removeEventListener(i, n.proxyListener, a), t.splice(e, 1));
              }
          }
        }
        return this;
      ...
      offset: function () {
        ...
        return 0 < this.length
          ? ((r = I()),
            ...
            (n = e === r ? r.scrollY : e.scrollTop),
            (r = e === r ? r.scrollX : e.scrollLeft),
            { top: t.top + n - i, left: t.left + r - s })
          : null;
      },
      css: function (e, t) {
        var i = I();
      ...
      eq: function (e) {
        ...
        return void 0 === e
          ? this
          : O((t = this.length) - 1 < e ? [] : e < 0 ? ((t = t + e) < 0 ? [] : [this[t]]) : [this[e]]);
      },
      append: function () {
        var i,
          s = E();
    ...
    function L(e, t) {
      ...
      e = (function (e) {
        ...
        let i;
        return (i =
          (i = !(i = t.getComputedStyle ? t.getComputedStyle(e, null) : i) && e.currentStyle ? e.currentStyle : i) ||
          e.style);
      })(e);
      return (
        i.WebKitCSSMatrix
            ...
            void 0 !== a &&
              ...
              (c(i[r]) && c(s[r])
                ? s[r].__swiper__
                  ? (i[r] = s[r])
                  : m(i[r], s[r])
                : c(i[r]) || !c(s[r]) || ((i[r] = {}), s[r].__swiper__)
                  ? (i[r] = s[r])
                  : m(i[r], s[r]));
          }
        }
    ...
    function p() {
      ...
      (n && 0 === n.offsetWidth) ||
        ...
        ('auto' === s.slidesPerView || 1 < s.slidesPerView) && i.isEnd && !i.isBeginning && !i.params.centeredSlides
    ...
    const g = (e, t) => {
        var i = E(),
          { params: s, touchEvents: n, el: r, wrapperEl: a, device: o, support: l } = e,
          c = !!s.nested,
        ...
        if (l.touch) {
          ...
          r[d](n.start, e.onTouchStart, t),
            r[d](n.move, e.onTouchMove, l.passiveListener ? { passive: !1, capture: c } : c),
        ...
        (s.preventClicks || s.preventClicksPropagation) && r[d]('click', e.onClick, !0),
          ...
          s.updateOnWindowResize
            ? e[t](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', p, !0)
    ...
    const x = {
        ...
        update: {
          ...
          updateSlides: function () {
            ...
            if (void 0 !== o) {
              ...
              for (let e = 0; e < h; e += 1) {
                ...
                if ((E && i.grid.updateSlide(e, l, h, s), 'none' !== l.css('display'))) {
                  if ('auto' === r.slidesPerView) {
                    ...
                    if (
                      (c && (l[0].style.transform = 'none'), d && (l[0].style.webkitTransform = 'none'), r.roundLengths)
                    )
              ...
              if (
                ((i.virtualSize = Math.max(i.virtualSize, o) + v),
                l &&
                  c &&
                  ('slide' === r.effect || 'coverflow' === r.effect) &&
                  a.css({ width: i.virtualSize + r.spaceBetween + 'px' }),
                r.setWrapperSize && a.css({ [s('width')]: i.virtualSize + r.spaceBetween + 'px' }),
              ...
              if (
                (Object.assign(i, { slides: u, snapGrid: p, slidesGrid: m, slidesSizesGrid: f }),
              ...
              if (
                ...
                p.length !== y && (i.params.watchOverflow && i.checkOverflow(), i.emit('snapGridLengthChange')),
          ...
          updateAutoHeight: function (e) {
            ...
            var a = (t) =>
              (s
                ? i.slides.filter((e) => parseInt(e.getAttribute('data-swiper-slide-index'), 10) === t)
                : i.slides.eq(t))[0];
          ...
          updateSlidesProgress: function (e) {
            ...
            var s = this,
              n = s.params,
              { slides: r, rtlTranslate: a, snapGrid: o } = s;
            if (0 !== r.length) {
              ...
              for (let t = 0; t < r.length; t += 1) {
                ...
                ((0 <= d && d < s.size - 1) || (1 < u && u <= s.size) || (d <= 0 && u >= s.size)) &&
                  (s.visibleSlides.push(l), s.visibleSlidesIndexes.push(t), r.eq(t).addClass(n.slideVisibleClass)),
                  (l.progress = a ? -O : O),
          ...
          updateProgress: function (e) {
            ...
            var o = r,
              l = a;
            (a = 0 == s ? ((n = 0), (r = !0)) : ((n = (e - t.minTranslate()) / s), (r = n <= 0), 1 <= n)),
          ...
          updateSlidesClasses: function () {
            ...
            e.removeClass(
              ...
              (r = r ? this.$wrapperEl.find(`.${t.slideClass}[data-swiper-slide-index="${s}"]`) : e.eq(s)).addClass(
                t.slideActiveClass
              ),
              t.loop &&
                (r.hasClass(t.slideDuplicateClass)
                  ? i.children(`.${t.slideClass}:not(.${t.slideDuplicateClass})[data-swiper-slide-index="${n}"]`)
                  : i.children(`.${t.slideClass}.${t.slideDuplicateClass}[data-swiper-slide-index="${n}"]`)
            ...
            t.loop && 0 === o.length && (o = e.eq(-1)).addClass(t.slidePrevClass),
              t.loop &&
                ((a.hasClass(t.slideDuplicateClass)
                  ? i.children(
                      `.${t.slideClass}:not(.${t.slideDuplicateClass})[data-swiper-slide-index="${a.attr('data-swiper-slide-index')}"]`
                    )
                  : i.children(
                      `.${t.slideClass}.${t.slideDuplicateClass}[data-swiper-slide-index="${a.attr('data-swiper-slide-index')}"]`
                    )
            ...
            c >= n.length && (c = n.length - 1),
              d === a
                ...
                : ((e = parseInt(t.slides.eq(d).attr('data-swiper-slide-index') || d, 10)),
                  Object.assign(t, { snapIndex: c, realIndex: e, previousIndex: a, activeIndex: d }),
            ...
            s && r
              ? ((t.clickedSlide = s),
                t.virtual && t.params.virtual.enabled
                  ? (t.clickedIndex = parseInt(O(s).attr('data-swiper-slide-index'), 10))
                  : (t.clickedIndex = n),
        ...
        translate: {
          ...
          setTranslate: function (e, t) {
            ...
            i.isHorizontal() ? (l = s ? -e : e) : (c = e),
              ...
              n.cssMode
                ? (a[i.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = i.isHorizontal() ? -l : -c)
                : n.virtualTranslate || r.transform(`translate3d(${l}px, ${c}px, 0px)`),
        ...
        transition: {
          ...
          transitionEnd: function (e, t) {
            ...
            var i = this['params'];
            (this.animating = !1),
              i.cssMode || (this.setTransition(0), u({ swiper: this, runCallbacks: e, direction: t, step: 'End' }));
          }
        },
        slide: {
          slideTo: function (e, t, i, s, n) {
            ...
            m >= o.length && (m = o.length - 1),
              (d || e.initialSlide || 0) === (c || 0) && i && r.emit('beforeSlideChangeStart');
            var f = -o[m];
            ...
            let g;
            if (
              ((g = a > d ? 'next' : a < d ? 'prev' : 'reset'), (u && -f === r.translate) || (!u && f === r.translate))
            )
              return (
          ...
          slidePrev: function (e, t, i) {
            ...
            if (
              (void 0 !== p &&
                ((m = o.indexOf(p)) < 0 && (m = s.activeIndex - 1), 'auto' === n.slidesPerView) &&
                1 === n.slidesPerGroup &&
          ...
          slideReset: function (e, t, i) {
            return (
              void 0 === e && (e = this.params.speed), this.slideTo(this.activeIndex, e, (t = void 0 === t ? !0 : t), i)
            );
          },
        ...
        loop: {
          ...
          loopFix: function () {
            ...
            t < s
              ? ((l = i.length - 3 * s + t),
                (l += s),
                e.slideTo(l, 0, !1, !0) && 0 != a && e.setTranslate((o ? -e.translate : e.translate) - a))
              : t >= i.length - s &&
                ((l = -i.length + t + s), (l += s), e.slideTo(l, 0, !1, !0)) &&
                0 != a &&
                e.setTranslate((o ? -e.translate : e.translate) - a),
              (e.allowSlidePrev = n),
              (e.allowSlideNext = r),
              e.emit('loopFix');
          },
        ...
        grabCursor: {
          setGrabCursor: function (e) {
            ...
            this.support.touch ||
              ...
              this.params.cssMode ||
              (((t = 'container' === this.params.touchEventsTarget ? this.el : this.wrapperEl).style.cursor = 'move'),
          ...
          attachEvents: function () {
            ...
            (e.onTouchStart = function (e) {
              var s = this,
                ...
                r = I(),
                a = s.touchEventsData,
                { params: o, touches: l, enabled: c } = s;
              if (c && (!s.animating || !o.preventInteractionOnTransition)) {
                ...
                if (
                  ('wrapper' !== o.touchEventsTarget || i.closest(s.wrapperEl).length) &&
                  ((a.isTouchEvent = 'touchstart' === t.type), a.isTouchEvent || !('which' in t) || 3 !== t.which) &&
                  !((!a.isTouchEvent && 'button' in t && 0 < t.button) || (a.isTouched && a.isMoved))
                ) {
                  o.noSwipingClass &&
                    '' !== o.noSwipingClass &&
                    t.target &&
                  ...
                  if (
                    ...
                    if (
                      ...
                      let e = !0;
                      i.is(a.focusableElements) && ((e = !1), 'SELECT' === i[0].nodeName) && (a.isTouched = !1),
                        n.activeElement &&
                          O(n.activeElement).is(a.focusableElements) &&
                          n.activeElement !== i[0] &&
              ...
              (e.onTouchMove = function (e) {
                var n = E(),
                  r = this,
                  a = r.touchEventsData,
                  { params: o, touches: l, rtlTranslate: c, enabled: t } = r;
                if (t) {
                  let s = e;
                  if ((s.originalEvent && (s = s.originalEvent), a.isTouched)) {
                    if (!a.isTouchEvent || 'touchmove' === s.type) {
                      (t = 'touchmove' === s.type && s.targetTouches && (s.targetTouches[0] || s.changedTouches[0])),
                      ...
                      if (s.preventedByNestedSwiper) (l.startX = e), (l.startY = t);
                        ...
                        if (
                          ...
                          O(s.target).is(a.focusableElements)
                        )
                            ...
                            if (
                              (void 0 === a.isScrolling &&
                                ...
                                (r.isVertical() && l.currentX === l.startX)
                                  ? (a.isScrolling = !1)
                                  : 25 <= n * n + d * d &&
                                    ((i = (180 * Math.atan2(Math.abs(d), Math.abs(n))) / Math.PI),
                                    (a.isScrolling = r.isHorizontal() ? i > o.touchAngle : 90 - i > o.touchAngle))),
                              ...
                              if (
                                ...
                                0 < e && a.currentTranslate > r.minTranslate()
                                  ? ((t = !1),
                                    o.resistance &&
                                      (a.currentTranslate =
                                        r.minTranslate() - 1 + (-r.minTranslate() + a.startTranslate + e) ** i))
                                  : e < 0 &&
                                    a.currentTranslate < r.maxTranslate() &&
                                    ((t = !1), o.resistance) &&
                                    (a.currentTranslate =
                                      r.maxTranslate() + 1 - (r.maxTranslate() - a.startTranslate - e) ** i),
                                ...
                                !r.allowSlidePrev &&
                                  ...
                                  a.currentTranslate > a.startTranslate &&
                                  (a.currentTranslate = a.startTranslate),
                                r.allowSlidePrev || r.allowSlideNext || (a.currentTranslate = a.startTranslate),
                                0 < o.threshold)
                              ) {
                                if (!(Math.abs(e) > o.threshold || a.allowThresholdMove))
                              ...
                              o.followFinger &&
                                !o.cssMode &&
                                (((o.freeMode && o.freeMode.enabled && r.freeMode) || o.watchSlidesProgress) &&
                        ...
                        O(s.target).is(a.focusableElements) || (r.allowClick = !1),
                          a.isTouched &&
                            (Object.assign(l, { startX: e, startY: t, currentX: e, currentY: t }),
                            (a.touchStartTime = v()));
                    }
              ...
              (e.onTouchEnd = function (r) {
                const a = this,
                  e = a.touchEventsData,
                  { params: o, touches: t, rtlTranslate: i, slidesGrid: l, enabled: s } = a;
                if (s) {
                  let n = r;
                  if (
                    (n.originalEvent && (n = n.originalEvent),
                    e.allowTouchCallbacks && a.emit('touchEnd', n),
                    ...
                    if (a.allowClick) {
                      ...
                      a.updateClickedSlide((r && r[0]) || n.target),
                        a.emit('tap click', n),
                        u < 300 && d - e.lastClickTime < 300 && a.emit('doubleTap doubleClick', n);
                    }
                    if (
                      ((e.lastClickTime = v()),
                      S(() => {
                      ...
                      if (
                        ...
                        (e.isMoved = !1),
                        (e.startMoving = !1),
                        (c = o.followFinger ? (i ? a.translate : -a.translate) : -e.currentTranslate),
                        !o.cssMode)
                      )
                        if (a.params.freeMode && o.freeMode.enabled) a.freeMode.onTouchEnd({ currentPos: c });
                          ...
                          for (let e = 0; e < l.length; e += e < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
                            ...
                            void 0 !== l[e + a]
                              ? c >= l[e] && c < l[e + a] && ((t = e), (i = l[e + a] - l[e]))
                              : c >= l[e] && ((t = e), (i = l[l.length - 1] - l[l.length - 2]));
                          }
                          let e = null,
                            s = null;
                          o.rewind &&
                          ...
                          u > o.longSwipesMs
                            ? o.longSwipes
                              ? ('next' === a.swipeDirection &&
                                  (r >= o.longSwipesRatio ? a.slideTo(o.rewind && a.isEnd ? e : t + d) : a.slideTo(t)),
                                'prev' === a.swipeDirection &&
                                  (r > 1 - o.longSwipesRatio
                                    ? a.slideTo(t + d)
                                    : null !== s && r < 0 && Math.abs(r) > o.longSwipesRatio
                                      ? a.slideTo(s)
                                      : a.slideTo(t)))
                              : a.slideTo(a.activeIndex)
                            : o.shortSwipes
                              ? !a.navigation || (n.target !== a.navigation.nextEl && n.target !== a.navigation.prevEl)
                                ? ('next' === a.swipeDirection && a.slideTo(null !== e ? e : t + d),
                                  'prev' === a.swipeDirection && a.slideTo(null !== s ? s : t))
                                : n.target === a.navigation.nextEl
                                  ? a.slideTo(t + d)
                                  : a.slideTo(t)
                              : a.slideTo(a.activeIndex);
                        }
              ...
              i.cssMode &&
                (e.onScroll = function () {
                  ...
                  s &&
                    ...
                    (0 == (s = e.maxTranslate() - e.minTranslate()) ? 0 : (e.translate - e.minTranslate()) / s) !==
              ...
              (e.onClick = function (e) {
                this.enabled &&
                  !this.allowClick &&
                  (this.params.preventClicks && e.preventDefault(), this.params.preventClicksPropagation) &&
                  this.animating &&
                  (e.stopPropagation(), e.stopImmediatePropagation());
              }.bind(e)),
              s.touch && !f && (t.addEventListener('touchstart', N), (f = !0)),
              g(e, 'on');
          },
            ...
            if (a && 0 !== Object.keys(a).length) {
              ...
              if (o && s.currentBreakpoint !== o) {
                ...
                Object.assign(s, {
                  ...
                  c &&
                    t &&
                    (s.loopDestroy(), s.loopCreate(), s.updateSlides(), s.slideTo(e - i + s.loopedSlides, 0, !1)),
                  s.emit('breakpoint', d);
              }
            }
          },
        ...
        classes: {
          addClasses: function () {
            var { classNames: e, params: t, rtl: i, $el: s, device: n, support: r } = this,
              r = (function (e, i) {
                const s = [];
                return (
                  e.forEach((t) => {
      ...
      constructor() {
        ...
        const r = this,
          a =
            ...
            (r.support = h()),
            (r.device =
              (void 0 === (u = { userAgent: i.userAgent }) && (u = {}),
              (d =
                d ||
                (function () {
          ...
          e({
            ...
            extendParams:
              ...
              function (e) {
                ...
                'object' == typeof i &&
                  null !== i &&
                  (0 <= ['navigation', 'pagination', 'scrollbar'].indexOf(t) && !0 === s[t] && (s[t] = { auto: !0 }),
                  t in s) &&
                  'enabled' in i &&
                  (!0 === s[t] && (s[t] = { enabled: !0 }),
        ...
        return (
          ...
          Object.assign(r, {
            ...
            touchEvents:
              ...
              (r.touchEventsTouch = { start: l[0], move: l[1], end: l[2], cancel: l[3] }),
      ...
      slidesPerViewDynamic(e, t) {
        ...
        if (i.centeredSlides) {
          ...
          for (let e = o + 1; e < s.length; e += 1)
            s[e] && !t && ((i += s[e].swiperSlideSize), (l += 1), i > a) && (t = !0);
      ...
      update() {
        ...
        t &&
          ...
          t.params.freeMode && t.params.freeMode.enabled
            ...
            : (('auto' === t.params.slidesPerView || 1 < t.params.slidesPerView) && t.isEnd && !t.params.centeredSlides
        ...
        if (!i.mounted) {
          ...
          let t =
            e && e.shadowRoot && e.shadowRoot.querySelector
              ? (((s = O(e.shadowRoot.querySelector(r()))).children = (e) => n.children(e)), s)
              : (n.children ? n : O(n)).children(r());
          var s;
          if (0 === t.length && i.params.createElements) {
            ...
            (t = O(e)),
              ...
              n.append(e),
              n.children('.' + i.params.slideClass).each((e) => {
                t.append(e);
              });
          }
          Object.assign(i, {
            ...
            rtlTranslate:
              'horizontal' === i.params.direction && ('rtl' === e.dir.toLowerCase() || 'rtl' === n.css('direction')),
      ...
      destroy(e, t) {
        ...
        if (void 0 !== i.params && !i.destroyed) {
          if (
            ...
            t &&
              (i.removeClasses(), n.removeAttr('style'), r.removeAttr('style'), a) &&
              a.length &&
              a
    ...
    return (
                ...
                (n = new ResizeObserver((i) => {
                  a = s.requestAnimationFrame(() => {
                    ...
                    i.forEach((e) => {
                      ...
                      (i && i !== r.el) ||
                        ((s = t ? t.width : (e[0] || e).inlineSize), (n = t ? t.height : (e[0] || e).blockSize));
                    }),
                      (s === e && n === t) || o();
                  });
                })).observe(r.el)
      ...
      T.use([
        function (e) {
          ...
          function T(e, t) {
            ...
            return i.cache && x.virtual.cache[t]
              ...
              : ((e = i.renderSlide
                  ...
                  : O(`<div class="${x.params.slideClass}" data-swiper-slide-index="${t}">${e}</div>`)).attr(
          ...
          function a(t) {
            const { slidesPerView: e, slidesPerGroup: i, centeredSlides: s } = x.params,
              ...
              { from: a, to: o, slides: l, slidesGrid: c, offset: d } = x.virtual;
            x.params.cssMode || x.updateActiveIndex();
            var u = x.activeIndex || 0;
            let h, p, m;
            (h = x.rtlTranslate ? 'right' : x.isHorizontal() ? 'left' : 'top'),
              (m = s ? ((p = Math.floor(e / 2) + i + r), Math.floor(e / 2) + i + n) : ((p = e + (i - 1) + r), i + n));
            ...
            if (
              (Object.assign(x.virtual, { from: f, to: g, offset: v, slidesGrid: x.slidesGrid }),
              a !== f || o !== g || t)
            )
              if (x.params.virtual.renderExternal)
                ...
                if (t) x.$wrapperEl.find('.' + x.params.slideClass).remove();
                  ...
                  for (let e = a; e <= o; e += 1)
                    (e < f || e > g) &&
                      x.$wrapperEl.find(`.${x.params.slideClass}[data-swiper-slide-index="${e}"]`).remove();
                for (let e = 0; e < l.length; e += 1)
                  e >= f && e <= g && (void 0 === o || t ? w.push(e) : (e > o && w.push(e), e < a && b.push(e)));
                w.forEach((e) => {
          ...
          function s(t) {
            if (u.enabled) {
              ...
              if (
                ...
                u.isHorizontal()
                  ? ((r || a || o || l) && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)),
                    (((a || l) && !i) || ((r || o) && i)) && u.slideNext(),
                    (((r || o) && !i) || ((a || l) && i)) && u.slidePrev())
                  : ((r || a || c || d) && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1)),
                    (a || d) && u.slideNext(),
                    (r || c) && u.slidePrev()),
                  h('keyPress', s);
              }
        ...
        function (e) {
          ...
          function m(e) {
            (c.params.mousewheel.thresholdDelta && e.delta < c.params.mousewheel.thresholdDelta) ||
              (c.params.mousewheel.thresholdTime && v() - n < c.params.mousewheel.thresholdTime) ||
              (6 <= e.delta && v() - n < 60) ||
              (e.direction < 0
                ? (c.isEnd && !c.params.loop) || c.animating || (c.slideNext(), d('scroll', e.raw))
                : (c.isBeginning && !c.params.loop) || c.animating || (c.slidePrev(), d('scroll', e.raw)),
          ...
          function o(s) {
            ...
            if (c.enabled) {
              ...
              let e = c.$el;
              if (
                ('container' !== c.params.mousewheel.eventsTarget && (e = O(c.params.mousewheel.eventsTarget)),
                !c.mouseEntered && !e[0].contains(n.target) && !a.releaseOnEdges)
              )
                return !0;
              n.originalEvent && (n = n.originalEvent);
              let t = 0;
              ...
              if (
                ((i = i >= c.minTranslate() ? c.minTranslate() : i) <= c.maxTranslate() && (i = c.maxTranslate()),
                (r = !!c.params.loop || !(i === c.minTranslate() || i === c.maxTranslate())) &&
                  c.params.nested &&
                  n.stopPropagation(),
                ...
                if (!r) {
                  ...
                  if (
                    ...
                    ((!O && c.isBeginning) || (!v && c.isEnd)) && c.updateSlidesClasses(),
          ...
          function l(e) {
            let t = c.$el;
            (t = 'container' !== c.params.mousewheel.eventsTarget ? O(c.params.mousewheel.eventsTarget) : t)[e](
              'mouseenter',
              r
            ),
              t[e]('mouseleave', a),
          ...
          function g() {
            return c.params.cssMode
              ...
              : !!c.mousewheel.enabled && (l('off'), !(c.mousewheel.enabled = !1));
          }
          i('init', () => {
        ...
        function (e) {
          ...
          function s(e) {
            ...
            return (t =
              e &&
              ((t = O(e)), n.params.uniqueNavElements) &&
              'string' == typeof e &&
              1 < t.length &&
          ...
          function l(e) {
            e.preventDefault(),
              (n.isBeginning && !n.params.loop && !n.params.rewind) || (n.slidePrev(), r('navigationPrev'));
          }
          function c(e) {
          ...
          function d() {
            ...
            (n.params.navigation = k(n, n.originalParams.navigation, n.params.navigation, {
              ...
              (i.nextEl || i.prevEl) &&
                ...
                Object.assign(n.navigation, { $nextEl: e, nextEl: e && e[0], $prevEl: t, prevEl: t && t[0] }),
                n.enabled || (e && e.addClass(i.lockClass), t && t.addClass(i.lockClass)));
          }
          function u() {
            var { $nextEl: e, $prevEl: t } = n.navigation;
            e && e.length && (e.off('click', c), e.removeClass(n.params.navigation.disabledClass)),
              t && t.length && (t.off('click', l), t.removeClass(n.params.navigation.disabledClass));
          }
          t({
            navigation: {
              nextEl: null,
            ...
            (n.navigation = { nextEl: null, $nextEl: null, prevEl: null, $prevEl: null }),
            i('init', () => {
            ...
            i('enable disable', () => {
              var { $nextEl: e, $prevEl: t } = n.navigation;
              e && e[n.enabled ? 'removeClass' : 'addClass'](n.params.navigation.lockClass),
                t && t[n.enabled ? 'removeClass' : 'addClass'](n.params.navigation.lockClass);
            }),
            i('click', (e, t) => {
              ...
              if (
                ...
                !O(t).is(s) &&
                !O(t).is(i) &&
                (!(n.pagination && n.params.pagination && n.params.pagination.clickable) ||
        ...
        function (e) {
          ...
          function s() {
            ...
            if (!h()) {
              ...
              if (
                (l.params.loop
                  ? ((n = Math.ceil((l.activeIndex - l.loopedSlides) / l.params.slidesPerGroup)) >
                      a - 1 - 2 * l.loopedSlides && (n -= a - 2 * l.loopedSlides),
                    n > i - 1 && (n -= i),
                    n < 0 && 'bullets' !== l.params.paginationType && (n = i + n))
                  : (n = void 0 !== l.snapIndex ? l.snapIndex : l.activeIndex || 0),
                'bullets' === r.type && l.pagination.bullets && 0 < l.pagination.bullets.length)
              ) {
                const a = l.pagination.bullets;
                let i, s, e;
                if (
                  (r.dynamicBullets &&
                    ((d = a.eq(0)[l.isHorizontal() ? 'outerWidth' : 'outerHeight'](!0)),
                    o.css(l.isHorizontal() ? 'width' : 'height', d * (r.dynamicMainBullets + 4) + 'px'),
                    1 < r.dynamicMainBullets &&
                      void 0 !== l.previousIndex &&
                      ((u += n - (l.previousIndex - l.loopedSlides || 0)) > r.dynamicMainBullets - 1
                        ? (u = r.dynamicMainBullets - 1)
                        : u < 0 && (u = 0)),
                    (i = Math.max(n - u, 0)),
                    (s = i + (Math.min(a.length, r.dynamicMainBullets) - 1)),
                    (e = (s + i) / 2)),
                  a.removeClass(
                  ...
                  a.each((e) => {
                    var e = O(e),
                      t = e.index();
                    t === n && e.addClass(r.bulletActiveClass),
                      r.dynamicBullets &&
                        (t >= i && t <= s && e.addClass(r.bulletActiveClass + '-main'),
                        t === i && p(e, 'prev'),
                        t === s) &&
                        p(e, 'next');
                  });
                    ...
                    if (l.params.loop)
                      if (o >= a.length) {
                        for (let e = r.dynamicMainBullets; 0 <= e; --e)
                          a.eq(a.length - e).addClass(r.bulletActiveClass + '-main');
              ...
              if (
                ('fraction' === r.type &&
                  (o.find(A(r.currentClass)).text(r.formatFractionCurrent(n + 1)),
              ...
              'custom' === r.type && r.renderCustom
                ? (o.html(r.renderCustom(l, n + 1, i)), c('paginationRender', o[0]))
                : c('paginationUpdate', o[0]),
                l.params.watchOverflow && l.enabled && o[l.isLocked ? 'addClass' : 'removeClass'](r.lockClass);
            }
          }
          function n() {
            ...
            if (!h()) {
              ...
              if ('bullets' === s.type) {
                let t = l.params.loop
                  ? Math.ceil((e - 2 * l.loopedSlides) / l.params.slidesPerGroup)
                  : l.snapGrid.length;
              ...
              'fraction' === s.type &&
                ...
                'progressbar' === s.type &&
                  ...
                  n.html(i)),
                'custom' !== s.type && c('paginationRender', l.pagination.$el[0]);
            }
          }
          function r() {
            ...
            if (t.el) {
              ...
              0 !== e.length &&
                ...
                'bullets' === t.type &&
                  t.dynamicBullets &&
                  (e.addClass('' + t.modifierClass + t.type + '-dynamic'), (u = 0), t.dynamicMainBullets < 1) &&
          ...
          function a() {
            ...
            h() ||
              ...
              t.clickable && e.off('click', A(t.bulletClass)));
          }
          i('init', () => {
        ...
        function (e) {
          ...
          function n() {
            if (l.params.scrollbar.el && l.scrollbar.el) {
              const { scrollbar: i, rtlTranslate: s, progress: n } = l,
                { $dragEl: r, $el: a } = i,
          ...
          function m() {
            ...
            l.params.scrollbar.el &&
              ...
              (s =
                l.size / (l.virtualSize + l.params.slidesOffsetBefore - (l.params.centeredSlides ? l.snapGrid[0] : 0))),
          ...
          function g(e) {
            var { scrollbar: t, rtlTranslate: i } = l,
              t = t['$el'];
            let s;
            (s = (f(e) - t.offset()[l.isHorizontal() ? 'left' : 'top'] - (null !== a ? a : c / 2)) / (d - c)),
            ...
            (u = !0),
              (a =
                e.target === n[0] || e.target === n
                  ? f(e) - e.target.getBoundingClientRect()[l.isHorizontal() ? 'left' : 'top']
                  : null),
              e.preventDefault(),
              e.stopPropagation(),
              s.transition(100),
          ...
          function b(e) {
            ...
            u &&
              ((u = !1),
              l.params.cssMode && (l.$wrapperEl.css('scroll-snap-type', ''), s.transition('')),
              t.hide &&
                (clearTimeout(p),
                (p = S(() => {
          ...
          function w(e) {
            var t,
              { scrollbar: i, touchEventsTouch: s, touchEventsDesktop: n, params: r, support: a } = l,
              i = i.$el;
            i &&
              ((i = i[0]),
              (t = !(!a.passiveListener || !r.passiveListeners) && { passive: !1, capture: !1 }),
              (r = !(!a.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 }),
              i) &&
              ((e = 'on' === e ? 'addEventListener' : 'removeEventListener'),
              a.touch
                ? (i[e](s.start, v, t), i[e](s.move, y, t), i[e](s.end, b, r))
                : (i[e](n.start, v, t), o[e](n.move, y, t), o[e](n.end, b, r)));
          }
          function x() {
            var { scrollbar: i, $el: s } = l,
              n =
                ((l.params.scrollbar = k(l, l.originalParams.scrollbar, l.params.scrollbar, {
                  el: 'swiper-scrollbar'
                })),
                l.params.scrollbar);
            if (n.el) {
              let e = O(n.el),
                t =
                  ((e =
                    l.params.uniqueNavElements && 'string' == typeof n.el && 1 < e.length && 1 === s.find(n.el).length
                      ? s.find(n.el)
                      : e).addClass(l.isHorizontal() ? n.horizontalClass : n.verticalClass),
                  e.find('.' + l.params.scrollbar.dragClass));
              0 === t.length && ((t = O(`<div class="${l.params.scrollbar.dragClass}"></div>`)), e.append(t)),
                Object.assign(i, { $el: e, el: e[0], $dragEl: t, dragEl: t[0] }),
              ...
              if (
                (n || r
                  ...
                  : l.isHorizontal()
                    ? ((n = i), (r = '0'))
                    : ((r = i), (n = '0')),
                (n = 0 <= n.indexOf('%') ? parseInt(n, 10) * t * e + '%' : n * t * e + 'px'),
        ...
        function (e) {
          ...
          function u(e) {
            ...
            0 !== E.$imageWrapEl.length)
              ? (E.$imageEl && E.$imageEl.transition(0), (o = !0))
              : (E.$imageEl = void 0);
          }
          function h(e) {
            var t = x.support,
            ...
            E.$imageEl && 0 !== E.$imageEl.length
              ? (t.gestures ? (s.scale = e.scale * T) : (s.scale = (E.scaleMove / E.scaleStart) * T),
                s.scale > E.maxRatio && (s.scale = E.maxRatio - 1 + (s.scale - E.maxRatio + 1) ** 0.5),
          ...
          function m(e) {
            ...
            if (E.$imageEl && 0 !== E.$imageEl.length && ((x.allowClick = !1), S.isTouched) && E.$slideEl) {
              S.isMoved ||
                ((S.width = E.$imageEl[0].offsetWidth),
                (S.height = E.$imageEl[0].offsetHeight),
                (S.startX = L(E.$imageWrapEl[0], 'x') || 0),
                (S.startY = L(E.$imageWrapEl[0], 'y') || 0),
              ...
              if (!(i < E.slideWidth && t < E.slideHeight)) {
                if (
                  ((S.minX = Math.min(E.slideWidth / 2 - i / 2, 0)),
                  (S.maxX = -S.minX),
          ...
          function g(y) {
            ...
            if (
              (E.$slideEl ||
                (y && y.target && (E.$slideEl = O(y.target).closest('.' + x.params.slideClass)),
                E.$slideEl ||
                  (x.params.virtual && x.params.virtual.enabled && x.virtual
                    ? (E.$slideEl = x.$wrapperEl.children('.' + x.params.slideActiveClass))
              ...
              x.params.cssMode && ((x.wrapperEl.style.overflow = 'hidden'), (x.wrapperEl.style.touchAction = 'none')),
                ...
                (t =
                  void 0 === S.touchesStart.x && y
                    ? ((e = ('touchend' === y.type ? y.changedTouches[0] : y).pageX),
                ...
                y
                  ? ((g = E.$slideEl[0].offsetWidth),
                    ...
                    (o = o < p ? p : o) > f && (o = f))
                  : ((a = 0), (o = 0)),
                E.$imageWrapEl.transition(300).transform(`translate3d(${a}px, ${o}px,0)`),
          ...
          function M() {
            ...
            s.enabled ||
              ...
              (i = w()),
              s.gestures
                ? (x.$wrapperEl.on(x.touchEvents.start, k, e), x.$wrapperEl.on(x.touchEvents.end, A, e))
                : 'touchstart' === x.touchEvents.start &&
                  (x.$wrapperEl.on(x.touchEvents.start, i, u, e),
                  x.$wrapperEl.on(x.touchEvents.move, i, h, t),
                  x.$wrapperEl.on(x.touchEvents.end, i, p, e),
                  x.touchEvents.cancel) &&
                  x.$wrapperEl.on(x.touchEvents.cancel, i, p, e),
              x.$wrapperEl.on(x.touchEvents.move, '.' + x.params.zoom.containerClass, m, t));
          }
          function P() {
            var e,
              t,
            ...
            s.enabled &&
              ((e = x.support),
              ({ passiveListener: s, activeListenerWithCapture: t } = ((s.enabled = !1), b())),
              (i = w()),
              e.gestures
                ? (x.$wrapperEl.off(x.touchEvents.start, k, s), x.$wrapperEl.off(x.touchEvents.end, A, s))
                : 'touchstart' === x.touchEvents.start &&
                  (x.$wrapperEl.off(x.touchEvents.start, i, u, s),
                  x.$wrapperEl.off(x.touchEvents.move, i, h, t),
                  x.$wrapperEl.off(x.touchEvents.end, i, p, s),
                  x.touchEvents.cancel) &&
                  x.$wrapperEl.off(x.touchEvents.cancel, i, p, s),
              x.$wrapperEl.off(x.touchEvents.move, '.' + x.params.zoom.containerClass, m, t));
          }
        ...
        function (e) {
                      ...
                      null == d ||
                        ...
                        d.params.loop &&
                          ...
                          c.hasClass(d.params.slideDuplicateClass)
                            ? h(
                                d.$wrapperEl
                                  .children(`[data-swiper-slide-index="${e}"]:not(.${d.params.slideDuplicateClass})`)
                                  .index(),
                                !1
                              )
                            : h(
                                d.$wrapperEl
                                  .children(`.${d.params.slideDuplicateClass}[data-swiper-slide-index="${e}"]`)
                                  .index(),
                                !1
                              )),
          ...
          function l() {
            ...
            if (('auto' === a && (a = 0), (c = c || !0), d.params.watchSlidesProgress))
              t.children('.' + i.slideVisibleClass).each((e) => {
                h(r ? O(e).attr('data-swiper-slide-index') : O(e).index());
              });
            else if (1 < a) for (let e = n; e < n + a; e += 1) o(e) && h(e);
            else h(n);
            if (e.loadPrevNext)
          ...
          i('beforeInit', () => {
            ...
            i('transitionStart', () => {
              d.params.lazy.enabled &&
                (d.params.lazy.loadOnTransitionStart || (!d.params.lazy.loadOnTransitionStart && !c)) &&
                (d.params.lazy.checkInView ? p : l)();
            }),
            i('transitionEnd', () => {
          ...
          t({ controller: { control: void 0, inverse: !1, by: 'slide' } }),
            ...
            Object.assign(o.controller, {
              setTranslate: function (e, t) {
                ...
                function a(e) {
                  ...
                  'slide' === o.params.controller.by &&
                    ...
                    (n && 'container' !== o.params.controller.by) ||
                      ((s = (e.maxTranslate() - e.minTranslate()) / (o.maxTranslate() - o.minTranslate())),
                ...
                if (Array.isArray(i)) for (let e = 0; e < i.length; e += 1) i[e] !== t && i[e] instanceof r && a(i[e]);
        ...
        function (e) {
          ...
          function p(e) {
            ...
            (13 !== e.keyCode && 32 !== e.keyCode) ||
              ...
              a.navigation &&
                ...
                ((a.isEnd && !a.params.loop) || a.slideNext(), a.isEnd ? s(t.lastSlideMessage) : s(t.nextSlideMessage)),
              a.navigation &&
                a.navigation.$prevEl &&
                e.is(a.navigation.$prevEl) &&
                ((a.isBeginning && !a.params.loop) || a.slidePrev(),
                a.isBeginning ? s(t.firstSlideMessage) : s(t.prevSlideMessage)),
              a.pagination && e.is(A(a.params.pagination.bulletClass)) && e[0].click());
          }
          function m() {
          ...
          const g = (e, t, i) => {
              n(e),
                'BUTTON' !== e[0].tagName && (l(e, 'button'), e.on('keydown', p)),
                d(e, i),
            ...
            v = (e) => {
              ...
              e &&
                ...
                (i = a.params.watchSlidesProgress && a.visibleSlides && a.visibleSlides.includes(e)),
                t ||
                  i ||
                  (a.isHorizontal() ? (a.el.scrollLeft = 0) : (a.el.scrollTop = 0), a.slideTo(a.slides.indexOf(e), 0)));
            },
            y = () => {
              const i = a.params.a11y,
                s =
                  (i.itemRoleDescriptionMessage && c(O(a.slides), i.itemRoleDescriptionMessage),
                  i.slideRole && l(O(a.slides), i.slideRole),
                  (a.params.loop
                    ? a.slides.filter((e) => !e.classList.contains(a.params.slideDuplicateClass))
                    : a.slides
                  ).length);
              i.slideLabelMessage &&
                a.slides.each((e, t) => {
          ...
          i('beforeInit', () => {
            ...
            i('afterInit', () => {
              if (a.params.a11y.enabled) {
                ...
                s.attr('id', n),
                  ...
                  f() && a.pagination.$el.on('keydown', A(a.params.pagination.bulletClass), p),
                  a.$el.on('focus', v, !0);
              }
            }),
            ...
            i('fromEdge toEdge afterInit lock unlock', () => {
              ...
              a.params.a11y.enabled &&
                ...
                t && 0 < t.length && (a.isBeginning ? (u(t), r) : (h(t), n))(t),
                e && 0 < e.length) &&
                (a.isEnd ? (u(e), r) : (h(e), n))(e);
            }),
            i('paginationUpdate', () => {
              if (a.params.a11y.enabled) {
                  ...
                  a.pagination.bullets.each((e) => {
                    ...
                    a.params.pagination.clickable &&
                      ...
                      a.params.pagination.renderBullet ||
                        (l(e, 'button'), d(e, t.paginationBulletMessage.replace(/\{\{index\}\}/, e.index() + 1)))),
                      e.is('.' + a.params.pagination.bulletActiveClass)
            ...
            i('destroy', () => {
              if (a.params.a11y.enabled) {
                ...
                o && 0 < o.length && o.remove(),
                  ...
                  e && e.off('keydown', p),
                  t && t.off('keydown', p),
                  f() && a.pagination.$el.off('keydown', A(a.params.pagination.bulletClass), p),
                  a.$el.off('focus', v, !0);
              }
            });
        },
        function (e) {
          ...
          i('init', () => {
            ...
            a.params.history.enabled &&
              ((e = I()), a.params.history) &&
              (e.history && e.history.pushState
                ? ((r = !0),
                  ((s = n(a.params.url)).key || s.value) &&
                    (c(0, s.value, a.params.runCallbacksOnInit),
            ...
            i('destroy', () => {
              var e;
              a.params.history.enabled &&
                ((e = I()), a.params.history.replaceState || e.removeEventListener('popstate', d));
            }),
            ...
            l =
              ...
              () => {
                ...
                e !== n.slides.eq(n.activeIndex).attr('data-hash') &&
                  void 0 !== (e = n.$wrapperEl.children(`.${n.params.slideClass}[data-hash="${e}"]`).index()) &&
                  n.slideTo(e);
              }),
            c = () => {
              var e;
              r &&
                ...
                (n.params.hashNavigation.replaceState && o.history && o.history.replaceState
                  ...
                  : ((e = (e = n.slides.eq(n.activeIndex)).attr('data-hash') || e.attr('data-history')),
                    (a.location.hash = e || '')),
                i('hashSet'));
            };
          s('init', () => {
            if (
              n.params.hashNavigation.enabled &&
              !(!n.params.hashNavigation.enabled || (n.params.history && n.params.history.enabled))
            ) {
              r = !0;
              ...
              if (s)
                for (let e = 0, t = n.slides.length; e < t; e += 1) {
                  ...
                  if (
                    ...
                    !i.hasClass(n.params.slideDuplicateClass)
                  ) {
                    const s = i.index();
        ...
        function (e) {
          ...
          function l() {
            return (
              !!s.autoplay.running &&
              void 0 !== i &&
              (i && (clearTimeout(i), (i = void 0)), (s.autoplay.running = !1), r('autoplayStop'), !0)
            );
          }
          function c(e) {
            !s.autoplay.running ||
          ...
          (s.autoplay = { running: !1, paused: !1 }),
            ...
            n('init', () => {
              s.params.autoplay.enabled &&
                (o(), E().addEventListener('visibilitychange', d), s.params.autoplay.pauseOnMouseEnter) &&
          ...
          function r() {
            ...
            if (e && !e.destroyed) {
              ...
              if (!((s && O(s).hasClass(l.params.thumbs.slideThumbActiveClass)) || null == i)) {
                let t;
                if (
                  ((t = e.params.loop ? parseInt(O(e.clickedSlide).attr('data-swiper-slide-index'), 10) : i),
                  l.params.loop)
                ) {
                  let e = l.activeIndex;
                  l.slides.eq(e).hasClass(l.params.slideDuplicateClass) &&
                    (l.loopFix(), (l._clientLeft = l.$wrapperEl[0].clientLeft), (e = l.activeIndex));
              ...
              if (l.realIndex !== n.realIndex || a) {
                ...
                if (n.params.loop) {
                  n.slides.eq(i).hasClass(n.params.slideDuplicateClass) &&
                    (n.loopFix(), (n._clientLeft = n.$wrapperEl[0].clientLeft), (i = n.activeIndex));
                ...
                a && (e += 'next' === t ? r : -1 * r),
                  n.visibleSlidesIndexes &&
                    ...
                    (n.params.centeredSlides
                      ? (e = e > i ? e - Math.floor(o / 2) + 1 : e + Math.floor(o / 2) - 1)
              ...
              freeMode: {
                ...
                onTouchMove: function () {
                  ...
                  0 === e.velocities.length &&
                    e.velocities.push({ position: t[h.isHorizontal() ? 'startX' : 'startY'], time: e.touchStartTime }),
                    ...
                    if (o.freeMode.momentum) {
                      ...
                      if (i < h.maxTranslate())
                        o.freeMode.momentumBounce
                          ? (i + h.maxTranslate() < -r && (i = h.maxTranslate() - r),
                            (t = h.maxTranslate()),
                            (s = !0),
                        ...
                        o.freeMode.momentumBounce
                          ? (i - h.minTranslate() > r && (i = h.minTranslate() + r),
                            (t = h.minTranslate()),
                            (s = !0),
                            (u.allowMomentumBounce = !0))
                          : (i = h.minTranslate()),
                        ...
                        i = -(i =
                          Math.abs(d[t] - i) < Math.abs(d[t - 1] - i) || 'next' === h.swipeDirection ? d[t] : d[t - 1]);
                      }
                      if (
                        (n &&
                          m('transitionEnd', () => {
            ...
            (m.grid = {
              ...
              updateWrapperSize: (i, s, e) => {
                var { spaceBetween: t, centeredSlides: n, roundLengths: r } = m.params,
                  a = m.params.grid['rows'];
                if (
                  ((m.virtualSize = (i + t) * u),
                  (m.virtualSize = Math.ceil(m.virtualSize / a) - t),
        ...
        function (e) {
          ...
          Object.assign(e, {
            ...
            addSlide: function (t, i) {
              var s = this,
                { $wrapperEl: n, params: r, activeIndex: a } = s;
              let o = a;
              if (
            ...
            M({
              ...
              setTransition: (e) => {
                ...
                (t ? a.slides.find(t) : a.slides).transition(e),
                  $({ swiper: a, duration: e, transformEl: t, allSlides: !0 });
              },
              overwriteParams: () => ({
                slidesPerView: 1,
                slidesPerGroup: 1,
        ...
        function (e) {
          ...
          const g = (e, t, i) => {
            ...
            0 === s.length && ((s = O(`<div class="swiper-slide-shadow-${i ? 'left' : 'top'}"></div>`)), e.append(s)),
              0 === n.length &&
                ((n = O(`<div class="swiper-slide-shadow-${i ? 'right' : 'bottom'}"></div>`)), e.append(n)),
          ...
          M({
            ...
            setTranslate: () => {
              ...
              for (let a = 0; a < o.length; a += 1) {
                ...
                O <= 1 && -1 < O && ((p = 90 * e + 90 * O), l) && (p = 90 * -e - 90 * O),
                  f.transform(m),
                  d.slideShadows && g(f, O, u);
              }
              if (
                (t.css({
                ...
                if (u)
                  ...
                  const e = Math.abs(p) - 90 * Math.floor(Math.abs(p) / 90),
                    ...
                    g = d.shadowOffset;
                  r.transform(
                    `scale3d(${t}, 1, ${o}) translate3d(0px, ${s / 2 + g}px, ${-s / 2 / o}px) rotateX(-90deg)`
                  );
                }
              var a = n.isSafari || n.isWebView ? -c / 2 : 0;
              t.transform(
                `translate3d(0px,0,${a}px) rotateX(${f.isHorizontal() ? 0 : p}deg) rotateY(${f.isHorizontal() ? -p : 0}deg)`
              ),
            ...
            setTranslate: () => {
              ...
              for (let r = 0; r < a.length; r += 1) {
                ...
                let t = -180 * e,
                  ...
                  n = 0;
                u.isHorizontal() ? o && (t = -t) : ((n = s), (s = 0), (i = -t), (t = 0)),
                  (c[0].style.zIndex = -Math.abs(Math.round(e)) + a.length),
          ...
          M({
            ...
            setTranslate: () => {
              ...
              for (let s = 0; s < n.length; s += 1) {
                ...
                m < 0 ? ((i = a.next), (t = !0)) : 0 < m && ((i = a.prev), (t = !0)),
                  g.forEach((e, t) => {
                    g[t] =
                      `calc(${e}px + (${((e = i.translate[t]), 'string' == typeof e ? e : e + 'px')} * ${Math.abs(m * o)}))`;
                  }),
                  v.forEach((e, t) => {
            ...
            setTransition: (e) => {
              ...
              (t ? y.slides.find(t) : y.slides).transition(e).find('.swiper-slide-shadow').transition(e),
                $({ swiper: y, duration: e, transformEl: t, allSlides: !0 });
            },
              ...
              setTranslate: () => {
                ...
                for (let a = 0; a < o.length; a += 1) {
                  ...
                  if (y || v) {
                    ...
                    (n += -28 * f * o), (s += -0.5 * o), (r += 96 * o), (i = -25 * o * Math.abs(f) + '%');
                  }
                  if (
                    ((t =
                      f < 0
      ...
      `);
                  if (c.slideShadows) {
                    ...
                    (e = 0 === e.length ? z(c, p) : e).length &&
                      (e[0].style.opacity = Math.min(Math.max((Math.abs(f) - 0.5) / 0.5, 0), 1));
                  }
