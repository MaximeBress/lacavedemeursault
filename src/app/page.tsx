        ...
        <div className="swiper">
          <div className="swiper-wrapper">
            <div
              ...
              data-image-src="/img/homepage/homepage1.jpg"
            >
            ...
            <div
              className="swiper-slide bg-overlay bg-overlay-400  bg-image !h-[750px] bg-[#21262c] !bg-cover !bg-[center_center] opacity-100 before:absolute before:left-0 before:top-0 before:z-[1] before:block before:h-full before:w-full before:bg-[rgba(30,34,40,.4)] before:content-['']"
              data-image-src="/img/homepage/homepage2.jpg"
            >
              <div className="container !h-full">
                <div className="mx-[-15px] flex !h-full flex-wrap">
                  <div className="!mx-auto w-full max-w-full flex-[0_0_auto] justify-center self-center px-[15px] !text-center md:w-11/12 lg:w-8/12 xl:w-7/12 xxl:w-6/12">
                    ...
                    <p className="lead animate__animated animate__slideInRight animate__delay-1s mb-7 text-[1.15rem] leading-normal text-white">
                      Nous partageons avec notre équipe l’envie d’offrir à notre clientèle les meilleurs vins de
                      Bourgogne, associés à un service personnalisé.
                    </p>
            ...
            <div
              className="swiper-slide bg-overlay bg-overlay-400 bg-image !h-[750px] bg-[#21262c] !bg-cover !bg-[center_center] opacity-100 before:absolute before:left-0 before:top-0 before:z-[1] before:block before:h-full before:w-full before:bg-[rgba(30,34,40,.4)] before:content-['']"
              data-image-src="/img/homepage/homepage3.jpg"
            >
              <div className="container !h-full">
                <div className="mx-[-15px] flex !h-full flex-wrap">
                  <div className="w-full max-w-full flex-[0_0_auto] items-start justify-center self-center px-[15px] text-center md:!ml-[8.33333333%] md:w-10/12 lg:!ml-0 lg:w-7/12 lg:text-left xl:w-6/12 xl:text-left">
                    ...
                    <p className="lead animate__animated animate__slideInRight animate__delay-1s mb-7 text-[1.15rem] leading-normal text-white">
                      Vous êtes unique, c’est pourquoi nos vins et notre service le sont également. Que vous soyez
                      livrés en fûts ou en bouteilles, notre seul désir : répondre à vos besoins.
                      <br />
                      Notre souci majeur est d’apprendre à mieux vous connaître pour mieux vous servir. A l’inverse, ce
                      site devrait vous permettre de découvrir qui nous sommes.
                    </p>
                    <div className="animate__animated animate__slideInUp animate__delay-1500ms">
                      <Link
