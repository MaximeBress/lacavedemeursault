  ...
  return (
    ...
    >
      ...
      >
        <div className="container !h-full">
          <div className="mx-[-15px] flex !h-full flex-wrap">
            <div className="w-full max-w-full flex-[0_0_auto] items-start justify-center self-center px-[15px] md:!ml-[8.33333333%] md:w-10/12 md:pt-10 lg:!ml-0 lg:w-7/12 lg:text-left xl:w-6/12 xl:text-left xsm:mt-10">
              <h2 className="font-great-vibes animate__animated animate__slideInDown animate__delay-500ms mb-2 text-[calc(1.405rem_+_1.86vw)] font-bold !leading-[1.2] text-white lg:mb-4 xl:mb-4 xl:text-[2.8rem]">
                À votre service
              </h2>
              <p className="lead animate__animated animate__slideInRight animate__delay-1s mb-2 leading-normal text-white lg:mb-7 lg:text-[1.15rem] xl:mb-7 xl:text-[1.15rem] xxl:text-[1.15rem]">
                ...
                <br />
                Notre soucis majeur est d’apprendre à mieux vous connaître pour mieux vous servir. A l’inverse, ce site
